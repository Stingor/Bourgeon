...
- **667 adresses distinctes**, 877 sites
- ⚓ 49 portées par l'annuaire (`ragnarok/*.h`, `ui/game_texture.h`)
- 96 présentes dans plusieurs fichiers (candidates annuaire si cohérentes)

| Adresse | Nom(s) | Sites | Commentaire |
|---|---|---|---|
| `0x00420000` | kSyntheticKeyLParam | `ragnarok\ragnarok_client.cc:59` |  |
| `0x004e52a0` | kStdStringCopyCtor | `features\windows\chat_window.cc:439` | __thiscall(dst, src), retn 4 |
| `0x004f08f0` | ⚓ kStdStringDtor, kStdStringDtorAddr, kStrDtor | `features\windows\chat_window.cc:96`<br>`ragnarok\globals.h:210`<br>`ragnarok\held_sprites.cc:41` | __thiscall(this) |
| `0x004f1940` | kStdStringAssign | `features\fx\palette_inject.cc:72`<br>`features\windows\chat_window.cc:95` | __thiscall(this, src, len) |
...
| `0x005a1460` | kCNameDict_GetEntryOrRequest, kNameDictGetEntry, kNameDictGetEntryOrRequest | `features\overlays\entity_names.cc:32`<br>`features\windows\chat_window.cc:849`<br>`features\windows\entity_context_menu.cc:93`<br>`features\windows\entity_inspector.cc:41`<br>`features\windows\vending_window.cc:289` | __thiscall(dict, gid) |
...
| `0x005c8950` | kEmblemRequestUpload | `features\windows\character_sheet.cc:1451` | __thiscall(this, guildId, std::string) |
...
| `0x006060ff` | (littéral) | `features\windows\chat_window.cc:6664` |  |
| `0x0060c820` | (littéral) | `ragnarok\configuration.h:13` |  |
| `0x00613100` | (littéral) | `ragnarok\configuration.h:14` |  |
| `0x0061d370` | kGetEmblemPath | `features\windows\character_sheet.cc:1214` | __thiscall(this, out_str, guildId) |
| `0x0061d560` | kGetEmblemVersion | `features\windows\character_sheet.cc:1306` | __thiscall(this, guildId) -> version |
| `0x00623e20` | (littéral) | `ragnarok\configuration.h:15` |  |
| `0x0065ae30` | (littéral) | `ragnarok\configuration.h:20` |  |
| `0x0068ea70` | kOptionInfoGetValue | `features\overlays\menu_icons.cc:236` | __cdecl(ttIndex) -> bool |
| `0x0068fd50` | kOptionInfoSetValue | `features\overlays\menu_icons.cc:237` | __cdecl(ttIndex, value) |
...
| `0x00715be0` | kStrLayerTex | `features\overlays\basic_info.cc:298` | Str_GetLayerTexture(layer, idx) |
| `0x00715d30` | kStrLayerTexDir | `features\overlays\basic_info.cc:330` | Str_GetLayerTextureWithDir(layer, idx, &dir) |
...
| `0x00738370` | kSkillGetTabList | `features\windows\character_sheet.cc:1010`<br>`features\windows\weapon_refine_window.cc:182`<br>`ragnarok\player_skills.cc:13` | __thiscall(bundle, tab) -> std::list* |
| `0x00738570` | kSkillSetUseLevel | `features\windows\character_sheet.cc:1011` | __thiscall(bundle, id, lv) |
| `0x00739cd0` | kSkillEntryDtor, kSkillInfoDtor | `features\overlays\skill_bar.cc:673`<br>`features\windows\character_sheet.cc:137`<br>`ragnarok\homunculus.cc:66` | = FUN_00739cd0 (cleanup de la struct) |
| `0x0073a140` | kGetSkillIdNameLua | `features\overlays\skill_bar.cc:564`<br>`features\windows\character_sheet.cc:182` | char* GetSkillIdName(int) __cdecl |
| `0x0073a1f0` | kGetSkillNameLua | `features\overlays\cast_bar.cc:35`<br>`features\overlays\skill_bar.cc:97`<br>`features\windows\character_sheet.cc:2389`<br>`features\windows\craft_atlas.cc:43`<br>`features\windows\monster_info_window.cc:393` | char* GetSkillName(int id) (__cdecl, via Lua) |
| `0x0073adb0` | kIsLevelUseSkill | `features\windows\character_sheet.cc:1013` | __cdecl(id) : l'effet dépend-il du niveau ? |
...
| `0x008dc0d0` | kChatToggleInputBar | `features\windows\chat_window.cc:477` | __thiscall(this), retn 0 |
| `0x008e1730` | kChatTagTransform | `features\windows\chat_window.cc:438` | __thiscall(this, out, in), retn 8 |
...
| `0x0095dfb0` | kBILayoutChildren | `features\overlays\basic_info.cc:2713` | __thiscall(wnd, height) |
...
| `0x009b9b9b` | (littéral) | `features\windows\chat_window.cc:5245` | COLORREF gris, comme les en-têtes du client |
...
| `0x00a2c600` | kFriendListAddByName | `features\windows\chat_window.cc:200` |  |
| `0x00a2cc20` | kWhisperPivotAddr | `features\windows\chat_window.cc:548` |  |
...
| `0x00a8e800` | kResAddRef, kTexAddRef | `features\fx\weapon_dual_sprites.cc:21`<br>`features\overlays\basic_info.cc:929` | resource AddRef (ECX = res) |
...
| `0x00a94930` | kStdStringFromFmt | `features\windows\character_sheet.cc:1452` | (dst, fmt, …) -> std::string du jeu |
...
| `0x00b90780` | kEffCtor | `features\overlays\basic_info.cc:790` | EffectInst_Ctor_StrNode(node) |
| `0x00bb4170` | kEffLoadStr | `features\overlays\basic_info.cc:791` | Effect_LoadStrByEffectId(node,src,id,x,y,z) |
...
| `0x00bced10` | kEffUpdateKF | `features\overlays\basic_info.cc:792` | Effect_UpdateStrKeyframes(node,offXYZ,f,f) |
| `0x00bcfb10` | kStrSubmitQuad | `features\overlays\basic_info.cc:297` | Effect_SubmitStrQuad (hooké) |
...
| `0x00c44940` | kToggleEffectId | `features\fx\spr_effect_lab.cc:29`<br>`features\overlays\basic_info.cc:525` | Actor_ToggleEffectId(actor, unifiedId, add) __thiscall |
...
| `0x00ca0c5d` | (littéral) | `bourgeon.cc:153` |  |
| `0x00caa2e0` | (littéral) | `ragnarok\configuration.h:89` |  |
| `0x00cb13c6` | (littéral) | `bourgeon.cc:153` |  |
...
| `0x00d5b580` | kGetJob | `features\overlays\basic_info.cc:129`<br>`features\overlays\basic_info.cc:1141`<br>`features\overlays\basic_info.cc:1354`<br>`features\windows\character_sheet.cc:819`<br>`features\windows\character_sheet.cc:2425`<br>`features\windows\palette_editor.cc:38` |  |
| `0x00d5bb40` | kJobDisplayName, kJobNameAddr, kJobResName | `features\overlays\basic_info.cc:131`<br>`features\windows\char_select.cc:398`<br>`features\windows\character_sheet.cc:821`<br>`features\windows\character_sheet.cc:834`<br>`features\windows\entity_inspector.cc:47`<br>`features\windows\rodex_window.cc:369`<br>… +2 | __thiscall(ctx, classId, sex) |
...
| `0x00d5cf50` | kPartyMemberCount | `features\windows\chat_window.cc:129` | __thiscall(ctxKey) |
| `0x00d5e1d0` | kShieldAct | `ragnarok\held_sprites.cc:34` |  |
| `0x00d5e240` | kShieldSpr | `ragnarok\held_sprites.cc:35` |  |
| `0x00d5e3c0` | kSkillGetUseLevel | `features\windows\character_sheet.cc:1012` | __thiscall(SESSION, id) — même tableau |
...
| `0x00d715f0` | kFriendListHasName | `features\windows\chat_window.cc:184` |  |
...
| `0x00d7fa90` | kGetInvItemAddr, kSkillEntryFill | `features\overlays\skill_bar.cc:257`<br>`features\overlays\skill_bar.cc:600`<br>`features\overlays\skill_bar.cc:671`<br>`features\windows\character_sheet.cc:136` | __stdcall(out, id) |
| `0x00d7fd30` | (littéral) | `features\windows\char_select.cc:985` |  |
| `0x00d7fe40` | kOwnGetCharName | `features\windows\chat_window.cc:562` | __thiscall(ctxKey) -> char* |
...
| `0x00d84760` | kGetSex | `features\overlays\basic_info.cc:141`<br>`features\windows\palette_editor.cc:35` | GetSex(session) |
| `0x00d87380` | kGetEFSTImg | `features\overlays\status_icon_bar.cc:46` | __thiscall(session,id,layer) -> const char* |
| `0x00d89ed0` | kTitleGetStr | `features\windows\character_sheet.cc:2037` |  |
...
| `0x00d99ca0` | kJobGetMaxBaseLevel | `features\overlays\basic_info.cc:2675` | __stdcall(jobId) |
| `0x00d99d30` | kJobGetMaxJobLevel | `features\overlays\basic_info.cc:2676` | __stdcall(jobId) |
...
| `0x00e8ddb6` | kWhisperRecvRgb | `features\windows\chat_window.cc:555` | reçu : bleu-gris pâle |
...
| `0x00ff00ff` | kEmblemClear | `features\minigames\roggle.cc:269`<br>`features\windows\character_sheet.cc:1540` | magenta pur = transparent en jeu |
...
| `0x00ffff00` | (littéral) | `features\windows\character_sheet.cc:1391` |  |
...
| `0x01013e88` | kStrCanvasCy | `features\overlays\basic_info.cc:455` | DAT_01013e88 (soustrait de workBuf[1]) |
...
| `0x01022f5c` | kStrCanvasCx | `features\overlays\basic_info.cc:454` | DAT_01022f5c (soustrait de workBuf[0]) |
...
| `0x0103e35c` | kBIMsgSlot | `features\overlays\basic_info.cc:2597` | vtable+0x94 OnMsg slot |
...
| `0x0121333c` | ⚓ kActiveModePtr, kCurrentModePtr | `features\windows\chat_window.cc:126`<br>`ragnarok\globals.h:53` | CMode* courant |
...
| `0x012517b8` | kEmblemDataMgrPtr | `features\windows\character_sheet.cc:1450` | *ptr = CEmblemDataMgr |
...
| `0x01254d70` | kCGuildMgrPtr | `features\windows\character_sheet.cc:1213` | *ptr = g_CGuildMgr (CGuildEmblemMgr) |
...
| `0x0131f50e` | kBattleModeFlag | `features\windows\chat_window.cc:476` |  |
| `0x0131f510` | kDetachedChatTree | `features\patches\chat.cc:774` | std::set<UIChatWnd*> head node |
| `0x0131f6b0` | kNewChatWndPtr | `features\windows\chat_window.cc:59`<br>`features\windows\inventory_viewer.cc:554` |  |
...
| `0x0131f6c4` | kBasicInfoPtr | `features\overlays\basic_info.cc:2849` | 0x0131f4e8 + 0x1dc |
...
| `0x0159c07c` | kClanStatePtr | `features\windows\chat_window.cc:130` | *(byte*)(*ptr + 0x5C) = clan |
| `0x0159c188` | kGuildBuf, kGuildObj | `features\patches\status_tweaks.cc:117`<br>`features\windows\character_sheet.cc:419` | std::string buffer/ptr union |
...
| `0x0159c1a0` | kGuildMasterName | `features\windows\character_sheet.cc:435` | std::string : nom du maître |
| `0x0159c1b8` | kGuildNoticeSubj | `features\windows\character_sheet.cc:442` | std::string : sujet de l'annonce (ZC 0x016f) |
| `0x0159c1d0` | kGuildNoticeBody | `features\windows\character_sheet.cc:443` | std::string : corps de l'annonce |
| `0x0159c1e8` | kGuildLevel | `features\windows\character_sheet.cc:421` |  |
| `0x0159c1f0` | kGuildOnlineNum | `features\windows\character_sheet.cc:436` | connect_member (membres en ligne) |
| `0x0159c1f4` | kGuildMemberMax | `features\windows\character_sheet.cc:437` | max_member |
| `0x0159c1f8` | kGuildAvgLevel | `features\windows\character_sheet.cc:438` | niveau moyen |
| `0x0159c1fc` | kGuildManageLand | `features\windows\character_sheet.cc:439` | std::string : territoire (nb de forts) |
| `0x0159c214` | kGuildExp | `features\windows\character_sheet.cc:440` | exp courante |
| `0x0159c218` | kGuildNextExp | `features\windows\character_sheet.cc:441` | exp du niveau suivant |
| `0x0159c230` | kGuildIdAddr, kOwnGuildId | `features\windows\character_sheet.cc:423`<br>`features\windows\chat_window.cc:128`<br>`features\windows\entity_context_menu.cc:152` |  |
| `0x0159c23c` | kGuildIsMaster | `features\windows\character_sheet.cc:422`<br>`features\windows\entity_context_menu.cc:153` |  |
| `0x0159c26c` | kGuildRelHead | `features\windows\character_sheet.cc:444` | CGuild+0xe4 : liste alliés/ennemis |
...
| `0x015fa3c0` | ⚓ kJobNameCtx, kSessionAddr, kUIWindowContextKey, kUiCtx | `features\windows\chat_window.cc:119`<br>`features\windows\entity_context_menu.cc:156`<br>`ragnarok\globals.h:24`<br>`ragnarok\homunculus.cc:67`<br>`ui\mob_sprite.cc:25` | g_UIWindowContextKey |
| `0x015fa3cc` | kSkillBundle | `features\windows\character_sheet.cc:1008`<br>`features\windows\weapon_refine_window.cc:180`<br>`ragnarok\player_skills.cc:11` | CPlayerSkillBundle (session+0x0C) |
| `0x015fa3e0` | kSkillFlatList | `features\windows\character_sheet.cc:1009`<br>`features\windows\weapon_refine_window.cc:181`<br>`ragnarok\player_skills.cc:12` | bundle+0x14 : l'onglet « divers » |
...
| `0x015fb278` | kHair | `features\overlays\basic_info.cc:142`<br>`features\windows\palette_editor.cc:72` | style de coiffure |
| `0x015fb28c` | kClothesCol | `features\overlays\basic_info.cc:143`<br>`features\windows\palette_editor.cc:73` | palette de vêtements |
| `0x015fb290` | kHairCol | `features\overlays\basic_info.cc:144`<br>`features\windows\palette_editor.cc:74` | palette de cheveux |
| `0x015fb294` | kHeadLowView | `features\overlays\basic_info.cc:149` | g_OwnLook_HeadBottomViewId |
| `0x015fb298` | kHeadTopView | `features\overlays\basic_info.cc:150` | g_OwnLook_HeadTopViewId |
| `0x015fb29c` | kHeadMidView | `features\overlays\basic_info.cc:151` | g_OwnLook_HeadMidViewId |
| `0x015fb2a0` | kGarmentView | `features\overlays\basic_info.cc:145` | g_OwnLook_GarmentRobeViewId |
...
| `0x015fb2f8` | kFriendOptOpenFromStranger | `features\windows\chat_window.cc:177` |  |
| `0x015fb2fc` | kFriendOptAlarm1on1 | `features\windows\chat_window.cc:178` |  |
| `0x015fb300` | kFriendOptOpenFromFriend | `features\windows\chat_window.cc:179` |  |
...
| `0x015fb9a4` | kAccountAid, kOwnAccountAid, kOwnAccountId, kOwnAid, kOwnAidAddr, kOwnHandlePtr | `features\fx\ez_effect_capture.cc:44`<br>`features\fx\style_sync.cc:22`<br>`features\gameplay\quick_cast.cc:41`<br>`features\overlays\basic_info.cc:156`<br>`features\windows\char_select.cc:213`<br>`features\windows\character_sheet.cc:141`<br>… +4 | handle/AID du joueur |
| `0x015fb9a8` | kOwnCharId, kOwnCharIdAddr | `features\hotkey_util.cc:23`<br>`features\fx\style_sync.cc:26`<br>`features\windows\character_sheet.cc:86`<br>`features\windows\palette_editor.cc:48` | g_Own_CharId (cf. project_own_session_globals) |
| `0x015fb9c8` | kOwnJobId, kOwnJobIdAddr | `features\overlays\basic_info.cc:154`<br>`features\windows\monster_info_window.cc:436`<br>`features\windows\palette_editor.cc:41` | g_Own_JobId |
| `0x015fb9d0` | (littéral) | `features\overlays\basic_info.cc:71` |  |
| `0x015fb9d8` | kOwnBaseExpNext | `features\overlays\basic_info.cc:71`<br>`features\overlays\basic_info.cc:2677` | g_Own_BaseExpNext (INT64) |
| `0x015fb9e0` | kOwnJobExpNext | `features\overlays\basic_info.cc:72`<br>`features\overlays\basic_info.cc:2678` | g_Own_JobExpNext  (INT64) |
| `0x015fb9e8` | (littéral) | `features\overlays\basic_info.cc:72` |  |
| `0x015fb9f0` | ⚓ kBaseLevel, kBaseLevelAddr, kBaseLvl | `features\overlays\basic_info.cc:116`<br>`features\windows\character_sheet.cc:101`<br>`ragnarok\globals.h:169` | DAT_015fb9f0 (UIBasicInfoWnd "Base Lv.") |
| `0x015fb9f4` | kStatusPoint, kStatusPt | `features\patches\status_tweaks.cc:114`<br>`features\windows\character_sheet.cc:94` |  |
| `0x015fb9f8` | ⚓ kBaseLvl, kJobLevel, kJobLevelAddr, kOwnJobLevel | `features\overlays\basic_info.cc:117`<br>`features\windows\character_sheet.cc:101`<br>`features\windows\weapon_refine_window.cc:70`<br>`ragnarok\globals.h:170` | DAT_015fb9f8 (UIBasicInfoWnd "Job Lv.") |
| `0x015fb9fc` | kSkillPointLvl, kSkillPointsAddr | `features\patches\skill_tree_tweaks.cc:42`<br>`features\windows\character_sheet.cc:1014` | changes when points are spent |
| `0x015fba04` | kSkillPts | `ragnarok\homunculus.cc:37` |  |
| `0x015fba0c` | ⚓ kStatBonus, kStatBonusAddr | `features\patches\status_tweaks.cc:103`<br>`features\windows\character_sheet.cc:92`<br>`ragnarok\globals.h:152` | bonus |
...
| `0x015fba24` | ⚓ kStatBase, kStatBaseAddr | `features\patches\status_tweaks.cc:101`<br>`features\windows\character_sheet.cc:91`<br>`ragnarok\globals.h:151` | STR..LUK base (step 4) |
...
| `0x015fba3c` | kRaiseCost | `features\patches\status_tweaks.cc:105`<br>`features\windows\character_sheet.cc:93` | cout de montee |
...
| `0x015fba54` | kAspdRaw, kFlee | `features\patches\status_tweaks.cc:113`<br>`features\windows\character_sheet.cc:100` |  |
| `0x015fba58` | kAtk1 | `features\patches\status_tweaks.cc:107`<br>`features\windows\character_sheet.cc:95` |  |
| `0x015fba5c` | kMdefSoft | `features\patches\status_tweaks.cc:109`<br>`features\windows\character_sheet.cc:98` |  |
| `0x015fba64` | kDefSoft | `features\patches\status_tweaks.cc:108`<br>`features\windows\character_sheet.cc:96` |  |
| `0x015fba68` | kDefSoft | `features\patches\status_tweaks.cc:108`<br>`features\windows\character_sheet.cc:96` |  |
| `0x015fba6c` | kAtk1 | `features\patches\status_tweaks.cc:107`<br>`features\windows\character_sheet.cc:95` |  |
| `0x015fba70` | kMatkMax, kMatkMin | `features\patches\status_tweaks.cc:110`<br>`features\windows\character_sheet.cc:97` |  |
| `0x015fba74` | kMatkMax, kMatkMin | `features\patches\status_tweaks.cc:110`<br>`features\windows\character_sheet.cc:97` |  |
| `0x015fba78` | kMdefSoft | `features\patches\status_tweaks.cc:109`<br>`features\windows\character_sheet.cc:98` |  |
| `0x015fba7c` | kHit, kOwnHit | `features\patches\status_tweaks.cc:111`<br>`features\windows\character_sheet.cc:99`<br>`features\windows\monster_info_window.cc:319` |  |
| `0x015fba80` | kFlee, kOwnFlee | `features\patches\status_tweaks.cc:112`<br>`features\windows\character_sheet.cc:100`<br>`features\windows\monster_info_window.cc:320` |  |
| `0x015fba84` | kHit, kOwnCrit | `features\patches\status_tweaks.cc:111`<br>`features\windows\character_sheet.cc:99`<br>`features\windows\monster_info_window.cc:321` |  |
| `0x015fba88` | kFlee, kOwnPdodge | `features\patches\status_tweaks.cc:112`<br>`features\windows\character_sheet.cc:100`<br>`features\windows\monster_info_window.cc:322` |  |
| `0x015fba8c` | kAmmoInvIndex | `features\windows\character_sheet.cc:117` | g_AmmoEquippedInvIndex (0 = aucune) |
| `0x015fba90` | ⚓ kZenyAddr | `ragnarok\globals.h:37` |  |
| `0x015fba9c` | kWeightMax | `features\overlays\basic_info.cc:76`<br>`features\patches\inventory_tweaks.cc:57`<br>`features\windows\inventory_viewer.cc:72` | max weight (raw) |
| `0x015fbaa0` | kWeightCur | `features\overlays\basic_info.cc:76`<br>`features\patches\inventory_tweaks.cc:56`<br>`features\windows\inventory_viewer.cc:71` | current weight (raw) |
| `0x015fbab0` | kInvListHead | `features\windows\character_sheet.cc:87`<br>`features\windows\chat_window.cc:65`<br>`features\windows\craft_atlas.cc:32`<br>`features\windows\inventory_viewer.cc:52`<br>`features\windows\make_item_window.cc:218`<br>`features\windows\npc_shop_window.cc:76`<br>… +3 | std::list<ItemSkillInfo> (session+0x16f0) |
| `0x015fbab4` | kInvCount | `features\windows\character_sheet.cc:88`<br>`features\windows\inventory_viewer.cc:53` | _Mysize |
...
| `0x015ff838` | kInputTargetMode | `features\windows\chat_window.cc:127` | 0 public 1 groupe 2 guilde 3 clan 4 alliés |
| `0x015ff908` | kHp | `features\overlays\basic_info.cc:73`<br>`features\windows\character_sheet.cc:102` |  |
| `0x015ff90c` | kHp | `features\overlays\basic_info.cc:73`<br>`features\windows\character_sheet.cc:102` |  |
| `0x015ff910` | kOwnSpCur, kSp | `features\overlays\basic_info.cc:74`<br>`features\windows\character_sheet.cc:103`<br>`features\windows\weapon_refine_window.cc:86` |  |
| `0x015ff914` | kSp | `features\overlays\basic_info.cc:74`<br>`features\windows\character_sheet.cc:103` |  |
...
| `0x015ffd14` | kShowEquipFlag | `features\windows\character_sheet.cc:142` | 1 = équip visible des autres (validé live) |
...
| `0x016004fc` | kOwnTitleId | `features\windows\character_sheet.cc:2032` | g_Own_TitleId : titre ÉQUIPÉ (0 = aucun) |
| `0x01600500` | kOwnTitleBegin | `features\windows\character_sheet.cc:2033` | std::vector<int> g_OwnTitleList : begin (possédés) |
| `0x01600504` | kOwnTitleEnd | `features\windows\character_sheet.cc:2034` | .. end |
...
| `0x016024c0` | kCostumeHideFlag | `features\windows\character_sheet.cc:143` | 0 = costumes affichés (validé live) |
