...
- **553 adresses distinctes**, 707 sites
- ⚓ 49 portées par l'annuaire (`ragnarok/*.h`, `ui/game_texture.h`)
- 75 présentes dans plusieurs fichiers (candidates annuaire si cohérentes)

| Adresse | Nom(s) | Sites | Commentaire |
|---|---|---|---|
| `0x004f08f0` | ⚓ kStdStringDtorAddr | `ragnarok\globals.h:210` |  |
...
| `0x0055c830` | kDX9DrawPrimRec | `features\fx\ground_paint.cc:73` | vtbl +0x38 : draw mono-texture |
| `0x0055c8c0` | kDX9DrawPrimDual | `features\fx\ground_paint.cc:74` | vtbl +0x34 : draw BI-texture (aniso) |
| `0x0055d680` | kDX9DrawGround | `features\fx\ground_paint.cc:49` | RendererDX9_DrawGroundTiles(this = renderer DX9) |
| `0x0055d850` | kDX9DrawTerrain | `features\fx\ground_paint.cc:75` | RendererDX9_DrawTerrainSurfaces |
...
| `0x005a1460` | kCNameDict_GetEntryOrRequest, kNameDictGetEntry | `features\overlays\entity_names.cc:31`<br>`features\windows\vending_window.cc:267` |  |
...
| `0x005c8950` | kEmblemRequestUpload | `features\windows\character_sheet.cc:1290` | __thiscall(this, guildId, std::string) |
...
| `0x00600770` | kSoundPlay3D | `features\minigames\roggle.cc:236`<br>`features\minigames\rojeweled.cc:91`<br>`features\windows\monster_info_window.cc:110` |  |
...
| `0x0061d370` | kGetEmblemPath | `features\windows\character_sheet.cc:1053` | __thiscall(this, out_str, guildId) |
| `0x0061d560` | kGetEmblemVersion | `features\windows\character_sheet.cc:1145` | __thiscall(this, guildId) -> version |
| `0x00623e20` | (littéral) | `ragnarok\configuration.h:15` |  |
| `0x0065ae30` | (littéral) | `ragnarok\configuration.h:20` |  |
| `0x0069f480` | kProbFetch | `features\windows\item_desc_window.cc:159` | ItemProbabilityDB_Fetch |
...
| `0x006a2970` | kGetCardResName | `features\windows\item_desc_window.cc:90` | __cdecl(id) -> record ; *record = resname |
| `0x006a2a70` | kGetDescLines | `features\windows\item_desc_window.cc:73` | ItemSkillDB_GetDescLines(info) -> &vector<char*> |
...
| `0x006a4bc0` | kGetResName | `features\windows\item_desc_window.cc:74`<br>`ui\icon_cache.cc:51` | ItemSkillDB_GetResName(info) -> resname C-str (icône) |
| `0x006a4c10` | ⚓ kSlotCountAddr | `ragnarok\item_db.h:55` |  |
| `0x006a5db0` | kBookDbContains | `features\windows\item_desc_window.cc:171` | BookItemDB_Contains |
...
| `0x00715be0` | kStrLayerTex | `features\overlays\basic_info.cc:274` | Str_GetLayerTexture(layer, idx) |
| `0x00715d30` | kStrLayerTexDir | `features\overlays\basic_info.cc:306` | Str_GetLayerTextureWithDir(layer, idx, &dir) |
...
| `0x0073a1f0` | kGetSkillNameLua | `features\overlays\skill_bar.cc:94`<br>`features\windows\character_sheet.cc:2109`<br>`features\windows\monster_info_window.cc:293` | char* GetSkillName(int id) (__cdecl, via Lua) |
...
| `0x0079d610` | kCharSelOnMsg | `features\windows\char_select.cc:109` | vtbl+0x94, RET 0x18 |
| `0x007a6df0` | kColorChip | `features\patches\inventory_tweaks.cc:141` | FUN_007a6df0(x,y,&r,&g,&b) -> colorchip.bmp pixel |
| `0x007c72e0` | kPurgeStaleMails | `features\windows\rodex_window.cc:130` | __thiscall(CRodexSystemMgr*) |
...
| `0x008217f0` | (littéral) | `features\windows\inventory_viewer.cc:529` |  |
...
| `0x00880e7f` | kSnapJnz | `features\patches\window_pos_tweaks.cc:341` | JNZ 0x00880e9f  (bytes 75 1e) |
...
| `0x008c18b0` | kItemDescWndAddr | `features\moonlight_ui\moonlight_ui.h:279` |  |
...
| `0x009030c0` | kHideNative, kSetVisibleFn | `features\overlays\skill_bar.cc:155`<br>`features\windows\item_desc_window.cc:72` | UIWnd_SetVisible (vtable+0x38, __thiscall) |
...
| `0x00a31a30` | (littéral) | `features\windows\char_select.cc:284`<br>`features\windows\char_select.cc:287` |  |
| `0x00a33005` | kSnapLoopHook | `features\patches\window_pos_tweaks.cc:362` | MOV ECX,[EBP-0x88] (8B 8D 78 FF FF FF) |
| `0x00a336d0` | kWndAtPointAddr | `features\gameplay\quick_cast.cc:32` |  |
...
| `0x00a4ad20` | kChatAddFn, kChatAddLine | `bourgeon.cc:154`<br>`features\windows\bank_window.cc:134`<br>`ragnarok\configuration.h:85` | = UIWindowMgr::SendMsg |
...
| `0x00a756e0` | (littéral) | `ragnarok\configuration.h:102` |  |
| `0x00a797b0` | kQuadTreeQueryPointAddr | `features\gameplay\quick_cast.cc:24` |  |
| `0x00a7b0a0` | (littéral) | `ragnarok\configuration.h:110` |  |
...
| `0x00a8e800` | kResAddRef, kTexAddRef | `features\fx\weapon_dual_sprites.cc:21`<br>`features\overlays\basic_info.cc:905` | resource AddRef (ECX = res) |
...
| `0x00a94930` | kStdStringFromFmt | `features\windows\character_sheet.cc:1291` | (dst, fmt, …) -> std::string du jeu |
...
| `0x00aa7b00` | (littéral) | `ragnarok\configuration.h:99` |  |
...
| `0x00b314f0` | kNaviRoute | `features\windows\item_desc_window.cc:111` | CNavigation::SearchRoute |
...
| `0x00b90780` | kEffCtor | `features\overlays\basic_info.cc:766` | EffectInst_Ctor_StrNode(node) |
| `0x00bb4170` | kEffLoadStr | `features\overlays\basic_info.cc:767` | Effect_LoadStrByEffectId(node,src,id,x,y,z) |
...
| `0x00bc2e04` | kEffectJumpTable | `features\fx\ez_effect_capture.cc:86`<br>`features\fx\spr_effect_lab.cc:553` |  |
| `0x00bced10` | kEffUpdateKF | `features\overlays\basic_info.cc:768` | Effect_UpdateStrKeyframes(node,offXYZ,f,f) |
| `0x00bcfb10` | kStrSubmitQuad | `features\overlays\basic_info.cc:273` | Effect_SubmitStrQuad (hooké) |
...
| `0x00c147d0` | (littéral) | `ragnarok\configuration.h:98` |  |
...
| `0x00c44940` | kToggleEffectId | `features\fx\spr_effect_lab.cc:27`<br>`features\overlays\basic_info.cc:501` | Actor_ToggleEffectId(actor, unifiedId, add) __thiscall |
| `0x00c69160` | kClampReach | `features\gameplay\keyboard_move.cc:17` | Move_ClampToReachableCell |
| `0x00c69a40` | kPickGroundCellAddr | `features\gameplay\quick_cast.cc:19` |  |
| `0x00c6aa80` | kWorldToTile | `features\gameplay\keyboard_move.cc:15` | MapCoord_WorldToTileAndSub |
| `0x00c6b1e0` | kOwnsItemById | `features\windows\item_desc_window.cc:172` | Inventory_OwnsItemById |
| `0x00c6cf80` | kCellValid | `features\gameplay\keyboard_move.cc:16` | Cell_IsMoveTargetValid |
| `0x00c74a80` | (littéral) | `ragnarok\configuration.h:106` |  |
| `0x00c82340` | kCamClamp | `features\gameplay\fps_view.cc:23` | Camera_ApplyViewDistanceClamp |
| `0x00c86740` | (littéral) | `ragnarok\configuration.h:73`<br>`ragnarok\configuration.h:107` |  |
| `0x00c8c8c7` | (littéral) | `features\overlays\entity_names.cc:153` |  |
| `0x00c93cb0` | kHitTestFn | `features\overlays\status_icon_bar.cc:112` |  |
| `0x00ca0c5d` | (littéral) | `bourgeon.cc:123` |  |
| `0x00caa2e0` | (littéral) | `ragnarok\configuration.h:89` |  |
| `0x00cb13c6` | (littéral) | `bourgeon.cc:123` |  |
| `0x00cf8b10` | kRecvDeleteResult | `features\windows\rodex_window.cc:290` |  |
| `0x00cfd0c0` | kRecvAckReadRodex | `features\windows\rodex_window.cc:234` | Recv_ZC_AckReadRodex_0x0B63 |
| `0x00d00010` | kApplyCheckNameAck | `features\windows\rodex_window.cc:336` | __stdcall, retn 0x10 |
| `0x00d21210` | (littéral) | `features\windows\char_select.cc:220`<br>`features\windows\char_select.cc:223` |  |
| `0x00d272e0` | (littéral) | `ragnarok\configuration.h:104` |  |
...
| `0x00d54c40` | kShopAddOrMerge | `features\windows\vending_window.cc:351` |  |
| `0x00d54d80` | kAvailAddOrMerge | `features\windows\vending_window.cc:354` |  |
| `0x00d54ea0` | kBasketAddOrMerge | `features\windows\vending_window.cc:362` | (session, rec) — 2 args ! |
| `0x00d55f80` | kShopCartResetAll | `features\windows\npc_shop_window.cc:160` |  |
| `0x00d56300` | kVendingBasketClear | `features\windows\vending_window.cc:183` | __thiscall(&session) |
| `0x00d57780` | (littéral) | `ragnarok\configuration.h:80` |  |
| `0x00d57a30` | kInvDecrease | `features\windows\trade_window.cc:61` |  |
| `0x00d57ac0` | kShopConsume | `features\windows\vending_window.cc:355` |  |
| `0x00d57c60` | kAvailConsume | `features\windows\vending_window.cc:352` |  |
| `0x00d57e40` | kBasketRemove | `features\windows\vending_window.cc:363` | (session, rec) — 2 args ! |
| `0x00d5a720` | kBuildIconPath, kEngBuildPath | `features\minigames\roggle.cc:207`<br>`features\overlays\skill_bar.cc:486`<br>`features\patches\chat.cc:97`<br>`ui\icon_cache.cc:15` | __fastcall(session, 0, idstr, outbuf, 0) |
| `0x00d5a980` | kGetSkillInfo | `features\overlays\skill_bar.cc:66` | SkillMgr_GetSkillInfo(mgr,out,id,gate) ; out+4!=0 => trouvé |
| `0x00d5b580` | (littéral) | `features\overlays\basic_info.cc:118`<br>`features\overlays\basic_info.cc:1066`<br>`features\overlays\basic_info.cc:1237`<br>`features\windows\character_sheet.cc:776`<br>`features\windows\character_sheet.cc:2145` |  |
| `0x00d5bb40` | kJobDisplayName, kJobResName | `features\overlays\basic_info.cc:120`<br>`features\windows\char_select.cc:360`<br>`features\windows\character_sheet.cc:778`<br>`features\windows\character_sheet.cc:791`<br>`features\windows\rodex_window.cc:368`<br>`ui\mob_sprite.cc:24` | __thiscall(ctx, classId, sex) |
| `0x00d5bea0` | kShopGetAt | `features\windows\vending_window.cc:335` |  |
| `0x00d5bf40` | kShopAmountBySrc | `features\windows\vending_window.cc:381` |  |
| `0x00d5c160` | kAvailGetAt | `features\windows\vending_window.cc:334` |  |
| `0x00d5c200` | kAvailAmountBySrc | `features\windows\vending_window.cc:380` |  |
| `0x00d5c580` | kBasketGetAt | `features\windows\vending_window.cc:361` | (session, out_rec, i) |
...
| `0x00d7f380` | kMailReturnAttachments | `features\windows\rodex_window.cc:64` |  |
| `0x00d7f480` | kMailClearAttachSlots | `features\windows\rodex_window.cc:65` |  |
| `0x00d7fa90` | kGetInvItemAddr, kSkillEntryFill | `features\overlays\skill_bar.cc:189`<br>`features\overlays\skill_bar.cc:504`<br>`features\overlays\skill_bar.cc:570`<br>`features\windows\character_sheet.cc:116` | __stdcall(out, id) |
| `0x00d7fd30` | (littéral) | `features\windows\char_select.cc:748` |  |
| `0x00d80140` | kMailAttachCountFn | `features\windows\rodex_window.cc:79` | __thiscall(session) -> int |
...
| `0x00d84760` | kGetSex | `features\overlays\basic_info.cc:130` | GetSex(session) |
| `0x00d87380` | kGetEFSTImg | `features\overlays\status_icon_bar.cc:45` | __thiscall(session,id,layer) -> const char* |
| `0x00d89ed0` | kTitleGetStr | `features\windows\character_sheet.cc:1873` |  |
...
| `0x00d99150` | kJobResolveBodyClass | `ui\doll.cc:68` |  |
...
| `0x00ff00ff` | kEmblemClear | `features\minigames\roggle.cc:268`<br>`features\windows\character_sheet.cc:1379` | magenta pur = transparent en jeu |
| `0x00ffaa00` | (littéral) | `features\overlays\dps_meter.cc:193` |  |
| `0x00ffe060` | (littéral) | `features\overlays\quest_tracker.h:18` | hunt progress lines ("mob ( x / y )") |
| `0x00ffff00` | (littéral) | `features\windows\character_sheet.cc:1230` |  |
| `0x00ffffff` | (littéral) | `features\minigames\roggle.cc:268`<br>`features\minigames\rojeweled.cc:401`<br>`features\minigames\rojeweled.cc:427`<br>`features\overlays\entity_names.cc:152`<br>`features\overlays\quest_tracker.h:17`<br>`features\overlays\status_icon_bar.cc:353`<br>… +2 | mob bleu clair / joueur+npc blanc |
| `0x01013e88` | kStrCanvasCy | `features\overlays\basic_info.cc:431` | DAT_01013e88 (soustrait de workBuf[1]) |
| `0x0101ca18` | kCashVTable | `features\windows\cashshop_window.cc:34` |  |
| `0x0101d424` | kCharSelWndVtbl | `features\windows\char_select.cc:108` | garde anti-pointeur périmé |
| `0x01021b30` | kWriteVTable | `features\windows\rodex_window.cc:48` |  |
| `0x01021e9e` | kIcoZenyPath | `features\windows\rodex_window.cc:391` | « \…\rodexsystem\renewal\icon_zeny.bmp » |
| `0x01021fbc` | kReadVTable | `features\windows\rodex_window.cc:36` |  |
| `0x01022170` | kInboxVTable | `features\windows\rodex_window.cc:35` | vérifiée live (g_RodexInboxWnd+0) |
| `0x01022a8e` | kIcoBothPath | `features\windows\rodex_window.cc:393` | « …\icon_zeny_n_item.bmp » |
| `0x01022ad6` | kIcoItemPath | `features\windows\rodex_window.cc:392` | « …\icon_item.bmp » |
| `0x01022f5c` | kStrCanvasCx | `features\overlays\basic_info.cc:430` | DAT_01022f5c (soustrait de workBuf[0]) |
| `0x010265e8` | kStyleshopPath | `features\windows\inventory_viewer.cc:653` | "유저인터페이스\styleshop\btn_buy_out.bmp" |
...
| `0x01032aac` | kItemVTable | `features\windows\item_desc_window.cc:46` | classe 0xc |
| `0x01032c5c` | kCompareVTable | `features\windows\item_desc_window.cc:58` | classe 0xea |
| `0x01032e0c` | kSkillVTable | `features\windows\item_desc_window.cc:47` | classe 0x2e |
| `0x01033754` | kAcceptVTable | `features\windows\trade_window.cc:42` | popup requête (best-effort) |
| `0x010345ac` | kVTableMakingArrow | `features\windows\make_item_window.cc:43` |  |
| `0x0103517c` | kBookVTable | `features\windows\item_desc_window.cc:182` |  |
| `0x010357b8` | kBtnbarPath, kUiPrefixPath | `features\patches\inventory_tweaks.cc:51`<br>`features\windows\cart_viewer.cc:237`<br>`features\windows\inventory_viewer.cc:647`<br>`features\windows\rodex_window.cc:390`<br>`features\windows\storage_window.cc:223` | "유저인터페이스\basic_interface\btnbar_left.bmp" (bottom-frame height) |
| `0x010361b4` | kBgNormalPath | `features\patches\status_tweaks.cc:71` | "...\statuswnd\w_statwin_bg.bmp" |
| `0x01036648` | kCardBmpPrefix | `features\windows\item_desc_window.cc:91` | "유저인터페이스\cardBmp\" (CP949, null-term) |
...
| `0x0103d538` | kCartVTable | `features\windows\cart_viewer.cc:46`<br>`features\windows\inventory_viewer.cc:131`<br>`features\windows\storage_window.cc:160` |  |
| `0x0103dad4` | kIconNumPath | `features\windows\cart_viewer.cc:239`<br>`features\windows\inventory_viewer.cc:649` | …\inventory\icon_num.bmp |
| `0x0103db00` | kIconPath, kIconWeightPath | `features\patches\inventory_tweaks.cc:50`<br>`features\windows\cart_viewer.cc:238`<br>`features\windows\inventory_viewer.cc:648` | "유저인터페이스\inventory\icon_weight.bmp" |
| `0x0103e35c` | kBIMsgSlot | `features\overlays\basic_info.cc:2435` | vtable+0x94 OnMsg slot |
...
| `0x010457d8` | kExchangeVTable | `features\windows\trade_window.cc:40` | CUIExchangeUI (fenêtre d'échange) |
...
| `0x01088a18` | kFmtBodyTail | `ui\doll.cc:24` |  |
| `0x01088a9c` | kFmtHeadgear | `ui\doll.cc:183` |  |
| `0x01088b88` | kFmtGarmentFlat | `ui\doll.cc:228` | sprite\로브\%s\%s.%s |
| `0x01088bbc` | kFmtGarmentJob | `ui\doll.cc:229` | sprite\로브\%s\%s\%s_%s.%s |
| `0x01088c48` | kEzChildVtbl | `features\fx\ez_effect_capture.cc:29` | vtable du nœud EZ enfant (celui que Draw dessine) |
| `0x0108f9bc` | kFmtSprFemale | `ui\head_icon.cc:16` | 인간족\머리통\여\%d_여.spr |
| `0x0108f9f4` | kFmtSprMale | `ui\head_icon.cc:17` | 인간족\머리통\남\%d_남.spr |
| `0x010904b8` | kGameModeVtable | `features\gameplay\quick_cast.cc:44`<br>`ragnarok\configuration.h:74` |  |
...
| `0x011e40d4` | kMouseScreenXAddr | `features\gameplay\quick_cast.cc:35`<br>`ragnarok\ragnarok_client.cc:156` |  |
| `0x011e40d8` | kMouseScreenYAddr | `features\gameplay\quick_cast.cc:36`<br>`ragnarok\ragnarok_client.cc:157` |  |
| `0x01213338` | ⚓ kModeMgrAddr | `ragnarok\globals.h:47` |  |
| `0x0121333c` | ⚓ kActiveModePtr | `ragnarok\globals.h:53` |  |
| `0x012135f0` | kNameplateQuadTreeAddr | `features\gameplay\quick_cast.cc:25` |  |
...
| `0x012517b8` | kEmblemDataMgrPtr | `features\windows\character_sheet.cc:1289` | *ptr = CEmblemDataMgr |
| `0x01253d0c` | kSoundMgrPtr | `features\minigames\roggle.cc:234`<br>`features\minigames\rojeweled.cc:89`<br>`features\overlays\login_parade.cc:27`<br>`features\windows\monster_info_window.cc:109` | *ptr = SoundMgr (déréf 1×) |
| `0x01254d70` | kCGuildMgrPtr | `features\windows\character_sheet.cc:1052` | *ptr = g_CGuildMgr (CGuildEmblemMgr) |
| `0x01254d90` | kQuestMgrPtr | `features\overlays\quest_tracker.cc:26` | void** -> quest manager |
| `0x01255108` | kProbDbPtr | `features\windows\item_desc_window.cc:158` | ptr vers le mgr (lazy-new) |
...
| `0x01255180` | kCardNilRecord | `features\windows\item_desc_window.cc:97` |  |
| `0x0131ecdc` | kRodexMgrPtr | `features\windows\rodex_window.cc:115` |  |
...
| `0x0131f6b0` | (littéral) | `features\windows\inventory_viewer.cc:533` |  |
...
| `0x0131f6c4` | kBasicInfoPtr | `features\overlays\basic_info.cc:2598` | 0x0131f4e8 + 0x1dc |
| `0x0131f700` | kItemDescWndGlobalPtr, kItemWndSlot | `features\moonlight_ui\moonlight_ui.h:287`<br>`features\windows\item_desc_window.cc:42` | mgr+0x218 : ITEM desc (classe 0xc) |
| `0x0131f708` | kCompareWndSlot | `features\windows\item_desc_window.cc:57` | mgr+0x220 : COMPARE desc (id 0xea) |
| `0x0131f718` | kSkillWndSlot | `features\windows\item_desc_window.cc:43` | mgr+0x230 : SKILL desc (classe 0x2e) |
...
| `0x0131f940` | kWriteWndPtr | `features\windows\rodex_window.cc:46` | g_MailWriteWnd (filet : doit rester nul) |
...
| `0x0159d410` | kFileMgr | `ui\spr_act.cc:29` | g_FileMgr (l'OBJET) |
| `0x0159d68c` | (littéral) | `ragnarok\configuration.h:100` |  |
| `0x015beecc` | kReplayActive | `ragnarok\skill_cooldowns.cc:23` | g_ReplayActive |
| `0x015c3090` | kNaviMgr | `features\windows\item_desc_window.cc:112` | &DAT_015c3090 (nav manager) |
| `0x015c5a24` | kSocketFd | `features\systems\native_login.cc:19` | g_RagConnection_SocketFd |
| `0x015f8262` | kSelectedSlot | `features\windows\char_select.cc:87` |  |
| `0x015fa3c0` | ⚓ kJobNameCtx, kSessionAddr | `ragnarok\globals.h:24`<br>`ui\mob_sprite.cc:25` |  |
...
| `0x015fb23c` | kAccountSex | `features\windows\char_select.cc:173` |  |
| `0x015fb278` | kHair | `features\overlays\basic_info.cc:131` | style de coiffure |
| `0x015fb28c` | kClothesCol | `features\overlays\basic_info.cc:132` | palette de vêtements |
| `0x015fb290` | kHairCol | `features\overlays\basic_info.cc:133` | palette de cheveux |
| `0x015fb2a0` | kGarmentView | `features\overlays\basic_info.cc:134` | g_OwnLook_GarmentRobeViewId |
| `0x015fb2a4` | kGarmentUseNewDrawOnTop | `ui\doll.cc:232` |  |
| `0x015fb2d4` | kCartNumItems | `features\windows\cart_viewer.cc:73` |  |
| `0x015fb2d8` | kCartMaxItems | `features\windows\cart_viewer.cc:74` |  |
| `0x015fb2dc` | kCartWeight | `features\windows\cart_viewer.cc:75` |  |
| `0x015fb2e0` | kCartMaxWeight | `features\windows\cart_viewer.cc:76` |  |
| `0x015fb9a4` | kAccountAid, kOwnAccountId, kOwnAidAddr, kOwnHandlePtr | `features\fx\ez_effect_capture.cc:44`<br>`features\gameplay\quick_cast.cc:39`<br>`features\windows\char_select.cc:175`<br>`features\windows\character_sheet.cc:121`<br>`features\windows\make_item_window.cc:311`<br>`features\windows\weapon_refine_window.cc:59` | handle/AID du joueur |
...
| `0x015fb9c8` | kOwnJobId, kOwnJobIdAddr | `features\overlays\basic_info.cc:137`<br>`features\windows\monster_info_window.cc:336` | g_Own_JobId |
| `0x015fb9d0` | (littéral) | `features\overlays\basic_info.cc:65` |  |
| `0x015fb9d8` | (littéral) | `features\overlays\basic_info.cc:65` |  |
| `0x015fb9e0` | (littéral) | `features\overlays\basic_info.cc:66` |  |
| `0x015fb9e8` | (littéral) | `features\overlays\basic_info.cc:66` |  |
| `0x015fb9f0` | ⚓ kBaseLevel, kBaseLevelAddr, kBaseLvl | `features\overlays\basic_info.cc:105`<br>`features\windows\character_sheet.cc:86`<br>`ragnarok\globals.h:169` | DAT_015fb9f0 (UIBasicInfoWnd "Base Lv.") |
| `0x015fb9f4` | kStatusPoint, kStatusPt | `features\patches\status_tweaks.cc:114`<br>`features\windows\character_sheet.cc:79` |  |
| `0x015fb9f8` | ⚓ kBaseLvl, kJobLevel, kJobLevelAddr, kOwnJobLevel | `features\overlays\basic_info.cc:106`<br>`features\windows\character_sheet.cc:86`<br>`features\windows\weapon_refine_window.cc:69`<br>`ragnarok\globals.h:170` | DAT_015fb9f8 (UIBasicInfoWnd "Job Lv.") |
...
| `0x015fba0c` | ⚓ kStatBonus, kStatBonusAddr | `features\patches\status_tweaks.cc:103`<br>`features\windows\character_sheet.cc:77`<br>`ragnarok\globals.h:152` | bonus |
...
| `0x015fba24` | ⚓ kStatBase, kStatBaseAddr | `features\patches\status_tweaks.cc:101`<br>`features\windows\character_sheet.cc:76`<br>`ragnarok\globals.h:151` | STR..LUK base (step 4) |
...
| `0x015fba7c` | kHit, kOwnHit | `features\patches\status_tweaks.cc:111`<br>`features\windows\character_sheet.cc:84`<br>`features\windows\monster_info_window.cc:246` |  |
| `0x015fba80` | kFlee, kOwnFlee | `features\patches\status_tweaks.cc:112`<br>`features\windows\character_sheet.cc:85`<br>`features\windows\monster_info_window.cc:247` |  |
| `0x015fba84` | kHit, kOwnCrit | `features\patches\status_tweaks.cc:111`<br>`features\windows\character_sheet.cc:84`<br>`features\windows\monster_info_window.cc:248` |  |
| `0x015fba88` | kFlee, kOwnPdodge | `features\patches\status_tweaks.cc:112`<br>`features\windows\character_sheet.cc:85`<br>`features\windows\monster_info_window.cc:249` |  |
...
| `0x015fba9c` | kWeightMax | `features\overlays\basic_info.cc:70`<br>`features\patches\inventory_tweaks.cc:57`<br>`features\windows\inventory_viewer.cc:70` | max weight (raw) |
| `0x015fbaa0` | kWeightCur | `features\overlays\basic_info.cc:70`<br>`features\patches\inventory_tweaks.cc:56`<br>`features\windows\inventory_viewer.cc:69` | current weight (raw) |
| `0x015fbab0` | kInvListHead | `features\windows\character_sheet.cc:72`<br>`features\windows\inventory_viewer.cc:50`<br>`features\windows\make_item_window.cc:216`<br>`features\windows\npc_shop_window.cc:73`<br>`features\windows\trade_window.cc:55`<br>`features\windows\weapon_refine_window.cc:77` | std::list<ItemSkillInfo> (session+0x16f0) |
| `0x015fbab4` | kInvCount | `features\windows\character_sheet.cc:73`<br>`features\windows\inventory_viewer.cc:51` | _Mysize |
| `0x015fbad8` | kStorageListHead | `features\windows\storage_window.cc:110`<br>`features\windows\storage_window.cc:783` |  |
| `0x015fbae0` | kCartListHead | `features\windows\cart_viewer.cc:58` | sentinelle std::list (head) |
| `0x015ff634` | kBodyResNamesBegin | `ui\doll.cc:69` |  |
| `0x015ff638` | kBodyResNamesEnd | `ui\doll.cc:70` |  |
| `0x015ff658` | kHeadgearNamesBegin | `ui\doll.cc:159` |  |
| `0x015ff65c` | kHeadgearNamesEnd | `ui\doll.cc:160` |  |
| `0x015ff7e0` | kNativeList | `ragnarok\skill_cooldowns.cc:28` | g_ShortCutCooldownList (objet std::list) |
| `0x015ff908` | kHp | `features\overlays\basic_info.cc:67`<br>`features\windows\character_sheet.cc:87` |  |
| `0x015ff90c` | kHp | `features\overlays\basic_info.cc:67`<br>`features\windows\character_sheet.cc:87` |  |
| `0x015ff910` | kSp | `features\overlays\basic_info.cc:68`<br>`features\windows\character_sheet.cc:88` |  |
| `0x015ff914` | kSp | `features\overlays\basic_info.cc:68`<br>`features\windows\character_sheet.cc:88` |  |
| `0x015ffd14` | kShowEquipFlag | `features\windows\character_sheet.cc:122` | 1 = équip visible des autres (validé live) |
| `0x015ffd60` | kNormalSlots | `features\windows\char_select.cc:131` |  |
| `0x015ffd64` | kPremiumSlots | `features\windows\char_select.cc:132` |  |
| `0x015ffd68` | kBillingSlots | `features\windows\char_select.cc:133` |  |
| `0x015ffd6c` | kCreatableSlots | `features\windows\char_select.cc:134` |  |
...
| `0x015fffa0` | kDropLockGlobal | `features\windows\inventory_viewer.cc:371` |  |
| `0x015fffa1` | kSafeCheckFlag | `features\windows\vending_window.cc:408` | octet, persistant |
| `0x015fffc0` | kBankVault | `features\windows\bank_window.cc:36` | s64 |
| `0x016004fc` | kOwnTitleId | `features\windows\character_sheet.cc:1868` | g_Own_TitleId : titre ÉQUIPÉ (0 = aucun) |
| `0x01600500` | kOwnTitleBegin | `features\windows\character_sheet.cc:1869` | std::vector<int> g_OwnTitleList : begin (possédés) |
| `0x01600504` | kOwnTitleEnd | `features\windows\character_sheet.cc:1870` | .. end |
| `0x01600553` | kDealLockGlobal, kFavFlag | `features\patches\inventory_tweaks.cc:105`<br>`features\windows\inventory_viewer.cc:372`<br>`features\windows\npc_shop_window.cc:87` | FAV-mode global (matches FUN_00946da0) |
| `0x01602278` | kLeftHandEquipOpt | `features\windows\inventory_viewer.cc:106` | DAT_01602278 : option client "équip main gauche" active ? |
...
| `0x016023e4` | kSnapName | `features\windows\vending_window.cc:302` | std::string : nom de la boutique |
| `0x01602400` | kSnapBegin | `features\windows\vending_window.cc:300` | vecteur d'ItemSkillInfo |
| `0x01602404` | kSnapEnd | `features\windows\vending_window.cc:301` |  |
