...
- **642 adresses distinctes**, 835 sites
- ⚓ 49 portées par l'annuaire (`ragnarok/*.h`, `ui/game_texture.h`)
- 88 présentes dans plusieurs fichiers (candidates annuaire si cohérentes)

| Adresse | Nom(s) | Sites | Commentaire |
|---|---|---|---|
| `0x00420000` | kSyntheticKeyLParam | `ragnarok\ragnarok_client.cc:58` |  |
| `0x004e52a0` | kStdStringCopyCtor | `features\windows\chat_window.cc:431` | __thiscall(dst, src), retn 4 |
| `0x004f08f0` | ⚓ kStdStringDtor, kStdStringDtorAddr, kStrDtor | `features\windows\chat_window.cc:94`<br>`ragnarok\globals.h:210`<br>`ragnarok\held_sprites.cc:41` | __thiscall(this) |
| `0x004f1940` | kStdStringAssign | `features\windows\chat_window.cc:93` | __thiscall(this, src, len) |
...
| `0x005a1460` | kCNameDict_GetEntryOrRequest, kNameDictGetEntry, kNameDictGetEntryOrRequest | `features\overlays\entity_names.cc:32`<br>`features\windows\chat_window.cc:835`<br>`features\windows\entity_context_menu.cc:91`<br>`features\windows\entity_inspector.cc:41`<br>`features\windows\vending_window.cc:268` | __thiscall(dict, gid) |
...
| `0x005c8950` | kEmblemRequestUpload | `features\windows\character_sheet.cc:1461` | __thiscall(this, guildId, std::string) |
...
| `0x00600770` | kSoundPlay3D | `features\minigames\roggle.cc:237`<br>`features\minigames\rojeweled.cc:92`<br>`features\windows\monster_info_window.cc:169` |  |
...
| `0x006060ff` | (littéral) | `features\windows\chat_window.cc:6332` |  |
| `0x0060c820` | (littéral) | `ragnarok\configuration.h:13` |  |
| `0x00613100` | (littéral) | `ragnarok\configuration.h:14` |  |
| `0x0061d370` | kGetEmblemPath | `features\windows\character_sheet.cc:1224` | __thiscall(this, out_str, guildId) |
| `0x0061d560` | kGetEmblemVersion | `features\windows\character_sheet.cc:1316` | __thiscall(this, guildId) -> version |
| `0x00623e20` | (littéral) | `ragnarok\configuration.h:15` |  |
| `0x0065ae30` | (littéral) | `ragnarok\configuration.h:20` |  |
| `0x0069f480` | kProbFetch | `features\windows\item_desc_window.cc:163` | ItemProbabilityDB_Fetch |
...
| `0x006a2970` | kGetCardResName | `features\windows\item_desc_window.cc:94` | __cdecl(id) -> record ; *record = resname |
| `0x006a2a70` | kGetDescLines | `features\windows\item_desc_window.cc:77` | ItemSkillDB_GetDescLines(info) -> &vector<char*> |
...
| `0x006a4bc0` | kGetResName | `features\windows\item_desc_window.cc:78`<br>`ui\icon_cache.cc:51` | ItemSkillDB_GetResName(info) -> resname C-str (icône) |
| `0x006a4c10` | ⚓ kSlotCountAddr | `ragnarok\item_db.h:55` |  |
| `0x006a5db0` | kBookDbContains | `features\windows\item_desc_window.cc:175` | BookItemDB_Contains |
...
| `0x00715be0` | kStrLayerTex | `features\overlays\basic_info.cc:282` | Str_GetLayerTexture(layer, idx) |
| `0x00715d30` | kStrLayerTexDir | `features\overlays\basic_info.cc:314` | Str_GetLayerTextureWithDir(layer, idx, &dir) |
...
| `0x00738370` | kSkillGetTabList | `features\windows\character_sheet.cc:1020`<br>`features\windows\weapon_refine_window.cc:182`<br>`ragnarok\player_skills.cc:13` | __thiscall(bundle, tab) -> std::list* |
| `0x00738570` | kSkillSetUseLevel | `features\windows\character_sheet.cc:1021` | __thiscall(bundle, id, lv) |
| `0x00739cd0` | kSkillEntryDtor, kSkillInfoDtor | `features\overlays\skill_bar.cc:673`<br>`features\windows\character_sheet.cc:127`<br>`ragnarok\homunculus.cc:66` | = FUN_00739cd0 (cleanup de la struct) |
| `0x0073a140` | kGetSkillIdNameLua | `features\overlays\skill_bar.cc:564`<br>`features\windows\character_sheet.cc:172` | char* GetSkillIdName(int) __cdecl |
| `0x0073a1f0` | kGetSkillNameLua | `features\overlays\cast_bar.cc:35`<br>`features\overlays\skill_bar.cc:97`<br>`features\windows\character_sheet.cc:2283`<br>`features\windows\craft_atlas.cc:43`<br>`features\windows\monster_info_window.cc:379` | char* GetSkillName(int id) (__cdecl, via Lua) |
| `0x0073adb0` | kIsLevelUseSkill | `features\windows\character_sheet.cc:1023` | __cdecl(id) : l'effet dépend-il du niveau ? |
...
| `0x007a7fa0` | kStdVectorIntPushBack | `features\windows\entity_context_menu.cc:89` | __thiscall(vec*, int*) |
...
| `0x00874af0` | (littéral) | `features\fx\screen_fx.cc:240` |  |
| `0x00880e7f` | kSnapJnz | `features\patches\window_pos_tweaks.cc:302` | JNZ 0x00880e9f  (bytes 75 1e) |
...
| `0x008c18b0` | kItemDescWndAddr | `features\moonlight_ui\moonlight_ui.h:326` |  |
...
| `0x008db420` | (littéral) | `features\fx\screen_fx.cc:242` |  |
| `0x008dc0d0` | kChatToggleInputBar | `features\windows\chat_window.cc:469` | __thiscall(this), retn 0 |
| `0x008e1730` | kChatTagTransform | `features\windows\chat_window.cc:430` | __thiscall(this, out, in), retn 8 |
...
| `0x009030c0` | kHideNative, kSetVisibleFn | `features\overlays\skill_bar.cc:158`<br>`features\windows\item_desc_window.cc:76` | UIWnd_SetVisible (vtable+0x38, __thiscall) |
...
| `0x0095dfb0` | kBILayoutChildren | `features\overlays\basic_info.cc:2603` | __thiscall(wnd, height) |
...
| `0x009b9b9b` | (littéral) | `features\windows\chat_window.cc:5011` | COLORREF gris, comme les en-têtes du client |
| `0x009ded20` | (littéral) | `ragnarok\configuration.h:64` |  |
| `0x009eb410` | (littéral) | `features\fx\screen_fx.cc:244` |  |
...
| `0x00a2c600` | kFriendListAddByName | `features\windows\chat_window.cc:198` |  |
| `0x00a2cc20` | kWhisperPivotAddr | `features\windows\chat_window.cc:534` |  |
...
| `0x00a33005` | kSnapLoopHook | `features\patches\window_pos_tweaks.cc:323` | MOV ECX,[EBP-0x88] (8B 8D 78 FF FF FF) |
| `0x00a336d0` | kWndAtPointAddr | `features\gameplay\quick_cast.cc:34` |  |
| `0x00a388f0` | kFriendListContains | `features\windows\entity_context_menu.cc:97` | __thiscall(mgr, name) |
...
| `0x00a4ad20` | kChatActionAddr, kChatAddLine | `features\windows\bank_window.cc:135`<br>`features\windows\chat_window.cc:53`<br>`ragnarok\configuration.h:85` | = UIWindowMgr::SendMsg |
| `0x00a50b70` | (littéral) | `ragnarok\configuration.h:31` |  |
| `0x00a5e960` | (littéral) | `ragnarok\configuration.h:32` |  |
| `0x00a69eb0` | kActorListFindByGid, kFindByGID | `features\gameplay\player_jump.cc:18`<br>`features\windows\entity_context_menu.cc:93` | ActorList_FindByGID(actorMgr,gid)->acteur |
| `0x00a727f0` | kActiveIdSetContains | `features\windows\entity_context_menu.cc:90` | __cdecl(aid) -> bool |
...
| `0x00a8e800` | kResAddRef, kTexAddRef | `features\fx\weapon_dual_sprites.cc:21`<br>`features\overlays\basic_info.cc:913` | resource AddRef (ECX = res) |
...
| `0x00a94930` | kStdStringFromFmt | `features\windows\character_sheet.cc:1462` | (dst, fmt, …) -> std::string du jeu |
...
| `0x00b314f0` | kNaviRoute | `features\windows\item_desc_window.cc:115` | CNavigation::SearchRoute |
...
| `0x00b90780` | kEffCtor | `features\overlays\basic_info.cc:774` | EffectInst_Ctor_StrNode(node) |
| `0x00bb4170` | kEffLoadStr | `features\overlays\basic_info.cc:775` | Effect_LoadStrByEffectId(node,src,id,x,y,z) |
...
| `0x00bc2e04` | kEffectJumpTable | `features\fx\ez_effect_capture.cc:86`<br>`features\fx\spr_effect_lab.cc:554` |  |
| `0x00bced10` | kEffUpdateKF | `features\overlays\basic_info.cc:776` | Effect_UpdateStrKeyframes(node,offXYZ,f,f) |
| `0x00bcfb10` | kStrSubmitQuad | `features\overlays\basic_info.cc:281` | Effect_SubmitStrQuad (hooké) |
...
| `0x00c44940` | kToggleEffectId | `features\fx\spr_effect_lab.cc:28`<br>`features\overlays\basic_info.cc:509` | Actor_ToggleEffectId(actor, unifiedId, add) __thiscall |
...
| `0x00c6b1e0` | kOwnsItemById | `features\windows\item_desc_window.cc:176` | Inventory_OwnsItemById |
| `0x00c6cf80` | kCellValid | `features\gameplay\keyboard_move.cc:18` | Cell_IsMoveTargetValid |
| `0x00c6e990` | kShowEntityContextMenu | `features\windows\entity_context_menu.cc:31` |  |
| `0x00c74a80` | (littéral) | `ragnarok\configuration.h:112` |  |
| `0x00c753a0` | kPostActorClickAction | `features\windows\entity_context_menu.cc:92` | __thiscall(gm, aid, flag) |
| `0x00c756a0` | kRouteHoverAndClick | `features\windows\entity_context_menu.cc:40` |  |
...
| `0x00ca0c5d` | (littéral) | `bourgeon.cc:146` |  |
| `0x00caa2e0` | (littéral) | `ragnarok\configuration.h:89` |  |
| `0x00cb13c6` | (littéral) | `bourgeon.cc:146` |  |
...
| `0x00d54c40` | kShopAddOrMerge | `features\windows\vending_window.cc:352` |  |
| `0x00d54d80` | kAvailAddOrMerge | `features\windows\vending_window.cc:355` |  |
| `0x00d54ea0` | kBasketAddOrMerge | `features\windows\vending_window.cc:363` | (session, rec) — 2 args ! |
| `0x00d55f80` | kShopCartResetAll | `features\windows\npc_shop_window.cc:210` |  |
| `0x00d56300` | kVendingBasketClear | `features\windows\vending_window.cc:184` | __thiscall(&session) |
| `0x00d57780` | (littéral) | `ragnarok\configuration.h:80` |  |
| `0x00d57a30` | kInvDecrease | `features\windows\trade_window.cc:62` |  |
| `0x00d57ac0` | kShopConsume | `features\windows\vending_window.cc:356` |  |
| `0x00d57c60` | kAvailConsume | `features\windows\vending_window.cc:353` |  |
| `0x00d57e40` | kBasketRemove | `features\windows\vending_window.cc:364` | (session, rec) — 2 args ! |
...
| `0x00d5b580` | (littéral) | `features\overlays\basic_info.cc:126`<br>`features\overlays\basic_info.cc:1074`<br>`features\overlays\basic_info.cc:1247`<br>`features\windows\character_sheet.cc:795`<br>`features\windows\character_sheet.cc:2319` |  |
| `0x00d5bb40` | kJobDisplayName, kJobResName | `features\overlays\basic_info.cc:128`<br>`features\windows\char_select.cc:383`<br>`features\windows\character_sheet.cc:797`<br>`features\windows\character_sheet.cc:810`<br>`features\windows\entity_inspector.cc:47`<br>`features\windows\rodex_window.cc:369`<br>… +1 | __thiscall(ctx, classId, sex) |
| `0x00d5bea0` | kShopGetAt | `features\windows\vending_window.cc:336` |  |
| `0x00d5bf40` | kShopAmountBySrc | `features\windows\vending_window.cc:382` |  |
| `0x00d5c160` | kAvailGetAt | `features\windows\vending_window.cc:335` |  |
| `0x00d5c200` | kAvailAmountBySrc | `features\windows\vending_window.cc:381` |  |
| `0x00d5c580` | kBasketGetAt | `features\windows\vending_window.cc:362` | (session, out_rec, i) |
| `0x00d5cf50` | kPartyMemberCount | `features\windows\chat_window.cc:127` | __thiscall(ctxKey) |
| `0x00d5e1d0` | kShieldAct | `ragnarok\held_sprites.cc:34` |  |
| `0x00d5e240` | kShieldSpr | `ragnarok\held_sprites.cc:35` |  |
| `0x00d5e3c0` | kSkillGetUseLevel | `features\windows\character_sheet.cc:1022` | __thiscall(SESSION, id) — même tableau |
| `0x00d5e590` | kLookupSlashCmd | `features\windows\chat_window.cc:123`<br>`ragnarok\configuration.h:81` | __thiscall(ctx, texte, &id, args[3]) |
| `0x00d715f0` | kFriendListHasName | `features\windows\chat_window.cc:182` |  |
| `0x00d7f1a0` | kCmdHandlerMap | `features\windows\chat_window.cc:116` | __thiscall(ctxKey, texte) |
...
| `0x00d7fa90` | kGetInvItemAddr, kSkillEntryFill | `features\overlays\skill_bar.cc:257`<br>`features\overlays\skill_bar.cc:600`<br>`features\overlays\skill_bar.cc:671`<br>`features\windows\character_sheet.cc:126` | __stdcall(out, id) |
| `0x00d7fd30` | (littéral) | `features\windows\char_select.cc:878` |  |
| `0x00d7fe40` | kOwnGetCharName | `features\windows\chat_window.cc:548` | __thiscall(ctxKey) -> char* |
| `0x00d80140` | kMailAttachCountFn | `features\windows\rodex_window.cc:80` | __thiscall(session) -> int |
| `0x00d806a0` | kActorFindByGid | `features\windows\entity_inspector.cc:30` | __stdcall(gid) |
...
| `0x00d89ed0` | kTitleGetStr | `features\windows\character_sheet.cc:2047` |  |
...
| `0x00d99860` | kAdoptionEligible | `features\windows\entity_context_menu.cc:126` | __stdcall(aid) -> bool |
| `0x00d99ca0` | kJobGetMaxBaseLevel | `features\overlays\basic_info.cc:2565` | __stdcall(jobId) |
| `0x00d99d30` | kJobGetMaxJobLevel | `features\overlays\basic_info.cc:2566` | __stdcall(jobId) |
...
| `0x00d9d220` | kIsHostileOrSpecial | `features\windows\entity_context_menu.cc:130` | __stdcall(aid, job) -> bool |
...
| `0x00e8ddb6` | kWhisperRecvRgb | `features\windows\chat_window.cc:541` | reçu : bleu-gris pâle |
...
| `0x00ff00ff` | kEmblemClear | `features\minigames\roggle.cc:269`<br>`features\windows\character_sheet.cc:1550` | magenta pur = transparent en jeu |
| `0x00ffaa00` | kOwnChatRgb | `features\overlays\dps_meter.cc:194`<br>`features\windows\entity_context_menu.cc:53` |  |
| `0x00ffe060` | (littéral) | `features\overlays\quest_tracker.h:18` | hunt progress lines ("mob ( x / y )") |
| `0x00ffff00` | (littéral) | `features\windows\character_sheet.cc:1401` |  |
...
| `0x01013e88` | kStrCanvasCy | `features\overlays\basic_info.cc:439` | DAT_01013e88 (soustrait de workBuf[1]) |
...
| `0x01022f5c` | kStrCanvasCx | `features\overlays\basic_info.cc:438` | DAT_01022f5c (soustrait de workBuf[0]) |
...
| `0x01032aac` | kItemVTable | `features\windows\item_desc_window.cc:50` | classe 0xc |
| `0x01032c5c` | kCompareVTable | `features\windows\item_desc_window.cc:62` | classe 0xea |
| `0x01032e0c` | kSkillVTable | `features\windows\item_desc_window.cc:51` | classe 0x2e |
...
| `0x0103517c` | kBookVTable | `features\windows\item_desc_window.cc:186` |  |
...
| `0x01036648` | kCardBmpPrefix | `features\windows\item_desc_window.cc:95` | "유저인터페이스\cardBmp\" (CP949, null-term) |
...
| `0x010384a0` | (littéral) | `features\fx\screen_fx.cc:241`<br>`features\fx\screen_fx.cc:242`<br>`features\fx\screen_fx.cc:319` |  |
...
| `0x0103e35c` | kBIMsgSlot | `features\overlays\basic_info.cc:2487` | vtable+0x94 OnMsg slot |
...
| `0x01047d7c` | (littéral) | `features\fx\screen_fx.cc:243`<br>`features\fx\screen_fx.cc:244` |  |
...
| `0x01091520` | (littéral) | `features\fx\screen_fx.cc:264` |  |
| `0x01091528` | (littéral) | `features\fx\screen_fx.cc:265` |  |
...
| `0x011e40e4` | kMouseLButtonState | `features\windows\entity_context_menu.cc:59` |  |
| `0x011e40e8` | kMouseRButtonState | `features\windows\entity_context_menu.cc:60` |  |
| `0x01213338` | ⚓ kModeMgrAddr | `ragnarok\globals.h:47` |  |
| `0x0121333c` | ⚓ kActiveModePtr, kCurrentModePtr | `features\windows\chat_window.cc:124`<br>`ragnarok\globals.h:53` | CMode* courant |
| `0x012135f0` | kNameplateQuadTreeAddr | `features\gameplay\quick_cast.cc:27` |  |
| `0x012291c0` | (littéral) | `features\fx\screen_fx.cc:247` | g_cam_zoomMaxOutdoor |
| `0x012291c4` | (littéral) | `features\fx\screen_fx.cc:248` | g_cam_zoomMaxIndoor |
...
| `0x012517b8` | kEmblemDataMgrPtr | `features\windows\character_sheet.cc:1460` | *ptr = CEmblemDataMgr |
| `0x01251824` | kChatBlockListPtr | `features\windows\entity_context_menu.cc:112` |  |
| `0x01253d0c` | kSoundMgrPtr | `features\minigames\roggle.cc:235`<br>`features\minigames\rojeweled.cc:90`<br>`features\overlays\login_parade.cc:27`<br>`features\windows\monster_info_window.cc:168` | *ptr = SoundMgr (déréf 1×) |
| `0x01254d70` | kCGuildMgrPtr | `features\windows\character_sheet.cc:1223` | *ptr = g_CGuildMgr (CGuildEmblemMgr) |
| `0x01254d90` | kQuestMgrPtr | `features\overlays\quest_tracker.cc:27` | void** -> quest manager |
| `0x01255108` | kProbDbPtr | `features\windows\item_desc_window.cc:162` | ptr vers le mgr (lazy-new) |
...
| `0x01255180` | kCardNilRecord | `features\windows\item_desc_window.cc:101` |  |
| `0x0131ecdc` | kRodexMgrPtr | `features\windows\rodex_window.cc:116` |  |
| `0x0131f4e8` | ⚓ kUIWindowMgr, kUIWindowMgrAddr | `features\overlays\chat_balloon.cc:49`<br>`features\windows\entity_context_menu.cc:98`<br>`ragnarok\uiwnd.h:25` | g_UIWindowMgr (l'OBJET, pas un pointeur vers lui) |
| `0x0131f50e` | kBattleModeFlag | `features\windows\chat_window.cc:468` |  |
| `0x0131f510` | kDetachedChatTree | `features\patches\chat.cc:774` | std::set<UIChatWnd*> head node |
| `0x0131f6b0` | kNewChatWndPtr | `features\windows\chat_window.cc:57`<br>`features\windows\inventory_viewer.cc:554` |  |
...
| `0x0131f6c4` | kBasicInfoPtr | `features\overlays\basic_info.cc:2739` | 0x0131f4e8 + 0x1dc |
| `0x0131f700` | kItemDescWndGlobalPtr, kItemWndSlot | `features\moonlight_ui\moonlight_ui.h:334`<br>`features\windows\item_desc_window.cc:46` | mgr+0x218 : ITEM desc (classe 0xc) |
| `0x0131f708` | kCompareWndSlot | `features\windows\item_desc_window.cc:61` | mgr+0x220 : COMPARE desc (id 0xea) |
| `0x0131f718` | kSkillWndSlot | `features\windows\item_desc_window.cc:47` | mgr+0x230 : SKILL desc (classe 0x2e) |
| `0x0131f764` | kNoPathFlag | `features\gameplay\keyboard_move.cc:20` | != 0 -> le natif passe en msg 0x10 |
| `0x0131f770` | ⚓ kStorageWndPtr, kStorageWndSlot | `features\windows\entity_context_menu.cc:69`<br>`ragnarok\uiwnd.h:101` | storage NATIF ouvert |
| `0x0131f940` | kWriteWndPtr | `features\windows\rodex_window.cc:47` | g_MailWriteWnd (filet : doit rester nul) |
| `0x0131f9c4` | kPendingSendText | `features\windows\chat_window.cc:92` | std::string |
...
| `0x0159c07c` | kClanStatePtr | `features\windows\chat_window.cc:128` | *(byte*)(*ptr + 0x5C) = clan |
| `0x0159c188` | kGuildBuf, kGuildObj | `features\patches\status_tweaks.cc:117`<br>`features\windows\character_sheet.cc:395` | std::string buffer/ptr union |
...
| `0x0159c1a0` | kGuildMasterName | `features\windows\character_sheet.cc:411` | std::string : nom du maître |
| `0x0159c1b8` | kGuildNoticeSubj | `features\windows\character_sheet.cc:418` | std::string : sujet de l'annonce (ZC 0x016f) |
| `0x0159c1d0` | kGuildNoticeBody | `features\windows\character_sheet.cc:419` | std::string : corps de l'annonce |
| `0x0159c1e8` | kGuildLevel | `features\windows\character_sheet.cc:397` |  |
| `0x0159c1f0` | kGuildOnlineNum | `features\windows\character_sheet.cc:412` | connect_member (membres en ligne) |
| `0x0159c1f4` | kGuildMemberMax | `features\windows\character_sheet.cc:413` | max_member |
| `0x0159c1f8` | kGuildAvgLevel | `features\windows\character_sheet.cc:414` | niveau moyen |
| `0x0159c1fc` | kGuildManageLand | `features\windows\character_sheet.cc:415` | std::string : territoire (nb de forts) |
| `0x0159c214` | kGuildExp | `features\windows\character_sheet.cc:416` | exp courante |
| `0x0159c218` | kGuildNextExp | `features\windows\character_sheet.cc:417` | exp du niveau suivant |
| `0x0159c230` | kGuildIdAddr, kOwnGuildId | `features\windows\character_sheet.cc:399`<br>`features\windows\chat_window.cc:126`<br>`features\windows\entity_context_menu.cc:150` |  |
| `0x0159c23c` | kGuildIsMaster | `features\windows\character_sheet.cc:398`<br>`features\windows\entity_context_menu.cc:151` |  |
| `0x0159c26c` | kGuildRelHead | `features\windows\character_sheet.cc:420` | CGuild+0xe4 : liste alliés/ennemis |
...
| `0x015beecc` | kReplayActive | `features\windows\entity_context_menu.cc:68`<br>`ragnarok\skill_cooldowns.cc:23` | lecture d'un replay |
| `0x015c3090` | kNaviMgr | `features\windows\item_desc_window.cc:116` | &DAT_015c3090 (nav manager) |
...
| `0x015fa3c0` | ⚓ kJobNameCtx, kSessionAddr, kUIWindowContextKey, kUiCtx | `features\windows\chat_window.cc:117`<br>`features\windows\entity_context_menu.cc:154`<br>`ragnarok\globals.h:24`<br>`ragnarok\homunculus.cc:67`<br>`ui\mob_sprite.cc:25` | g_UIWindowContextKey |
| `0x015fa3cc` | kSkillBundle | `features\windows\character_sheet.cc:1018`<br>`features\windows\weapon_refine_window.cc:180`<br>`ragnarok\player_skills.cc:11` | CPlayerSkillBundle (session+0x0C) |
| `0x015fa3e0` | kSkillFlatList | `features\windows\character_sheet.cc:1019`<br>`features\windows\weapon_refine_window.cc:181`<br>`ragnarok\player_skills.cc:12` | bundle+0x14 : l'onglet « divers » |
...
| `0x015faadc` | kChannelRegistryAddr | `features\windows\chat_window.cc:77` |  |
| `0x015faae4` | kDetachedRegistryAddr | `features\windows\chat_window.cc:78` |  |
...
| `0x015fb2f8` | kFriendOptOpenFromStranger | `features\windows\chat_window.cc:175` |  |
| `0x015fb2fc` | kFriendOptAlarm1on1 | `features\windows\chat_window.cc:176` |  |
| `0x015fb300` | kFriendOptOpenFromFriend | `features\windows\chat_window.cc:177` |  |
...
| `0x015fb3b0` | kOwnPetAid | `features\windows\entity_context_menu.cc:153` |  |
| `0x015fb9a4` | kAccountAid, kOwnAccountAid, kOwnAccountId, kOwnAidAddr, kOwnHandlePtr | `features\fx\ez_effect_capture.cc:44`<br>`features\gameplay\quick_cast.cc:41`<br>`features\windows\char_select.cc:198`<br>`features\windows\character_sheet.cc:131`<br>`features\windows\entity_context_menu.cc:149`<br>`features\windows\make_item_window.cc:313`<br>… +1 | handle/AID du joueur |
| `0x015fb9a8` | kOwnCharId | `features\hotkey_util.cc:23`<br>`features\windows\character_sheet.cc:81` | g_Own_CharId (cf. project_own_session_globals) |
| `0x015fb9c8` | kOwnJobId, kOwnJobIdAddr | `features\overlays\basic_info.cc:145`<br>`features\windows\monster_info_window.cc:422` | g_Own_JobId |
| `0x015fb9d0` | (littéral) | `features\overlays\basic_info.cc:68` |  |
| `0x015fb9d8` | kOwnBaseExpNext | `features\overlays\basic_info.cc:68`<br>`features\overlays\basic_info.cc:2567` | g_Own_BaseExpNext (INT64) |
| `0x015fb9e0` | kOwnJobExpNext | `features\overlays\basic_info.cc:69`<br>`features\overlays\basic_info.cc:2568` | g_Own_JobExpNext  (INT64) |
| `0x015fb9e8` | (littéral) | `features\overlays\basic_info.cc:69` |  |
| `0x015fb9f0` | ⚓ kBaseLevel, kBaseLevelAddr, kBaseLvl | `features\overlays\basic_info.cc:113`<br>`features\windows\character_sheet.cc:96`<br>`ragnarok\globals.h:169` | DAT_015fb9f0 (UIBasicInfoWnd "Base Lv.") |
| `0x015fb9f4` | kStatusPoint, kStatusPt | `features\patches\status_tweaks.cc:114`<br>`features\windows\character_sheet.cc:89` |  |
| `0x015fb9f8` | ⚓ kBaseLvl, kJobLevel, kJobLevelAddr, kOwnJobLevel | `features\overlays\basic_info.cc:114`<br>`features\windows\character_sheet.cc:96`<br>`features\windows\weapon_refine_window.cc:70`<br>`ragnarok\globals.h:170` | DAT_015fb9f8 (UIBasicInfoWnd "Job Lv.") |
| `0x015fb9fc` | kSkillPointLvl, kSkillPointsAddr | `features\patches\skill_tree_tweaks.cc:42`<br>`features\windows\character_sheet.cc:1024` | changes when points are spent |
| `0x015fba04` | kSkillPts | `ragnarok\homunculus.cc:37` |  |
| `0x015fba0c` | ⚓ kStatBonus, kStatBonusAddr | `features\patches\status_tweaks.cc:103`<br>`features\windows\character_sheet.cc:87`<br>`ragnarok\globals.h:152` | bonus |
...
| `0x015fba24` | ⚓ kStatBase, kStatBaseAddr | `features\patches\status_tweaks.cc:101`<br>`features\windows\character_sheet.cc:86`<br>`ragnarok\globals.h:151` | STR..LUK base (step 4) |
...
| `0x015fba3c` | kRaiseCost | `features\patches\status_tweaks.cc:105`<br>`features\windows\character_sheet.cc:88` | cout de montee |
...
| `0x015fba54` | kAspdRaw, kFlee | `features\patches\status_tweaks.cc:113`<br>`features\windows\character_sheet.cc:95` |  |
| `0x015fba58` | kAtk1 | `features\patches\status_tweaks.cc:107`<br>`features\windows\character_sheet.cc:90` |  |
| `0x015fba5c` | kMdefSoft | `features\patches\status_tweaks.cc:109`<br>`features\windows\character_sheet.cc:93` |  |
| `0x015fba64` | kDefSoft | `features\patches\status_tweaks.cc:108`<br>`features\windows\character_sheet.cc:91` |  |
| `0x015fba68` | kDefSoft | `features\patches\status_tweaks.cc:108`<br>`features\windows\character_sheet.cc:91` |  |
| `0x015fba6c` | kAtk1 | `features\patches\status_tweaks.cc:107`<br>`features\windows\character_sheet.cc:90` |  |
| `0x015fba70` | kMatkMax, kMatkMin | `features\patches\status_tweaks.cc:110`<br>`features\windows\character_sheet.cc:92` |  |
| `0x015fba74` | kMatkMax, kMatkMin | `features\patches\status_tweaks.cc:110`<br>`features\windows\character_sheet.cc:92` |  |
| `0x015fba78` | kMdefSoft | `features\patches\status_tweaks.cc:109`<br>`features\windows\character_sheet.cc:93` |  |
| `0x015fba7c` | kHit, kOwnHit | `features\patches\status_tweaks.cc:111`<br>`features\windows\character_sheet.cc:94`<br>`features\windows\monster_info_window.cc:305` |  |
| `0x015fba80` | kFlee, kOwnFlee | `features\patches\status_tweaks.cc:112`<br>`features\windows\character_sheet.cc:95`<br>`features\windows\monster_info_window.cc:306` |  |
| `0x015fba84` | kHit, kOwnCrit | `features\patches\status_tweaks.cc:111`<br>`features\windows\character_sheet.cc:94`<br>`features\windows\monster_info_window.cc:307` |  |
| `0x015fba88` | kFlee, kOwnPdodge | `features\patches\status_tweaks.cc:112`<br>`features\windows\character_sheet.cc:95`<br>`features\windows\monster_info_window.cc:308` |  |
| `0x015fba8c` | kAmmoInvIndex | `features\windows\character_sheet.cc:107` | g_AmmoEquippedInvIndex (0 = aucune) |
...
| `0x015fbab0` | kInvListHead | `features\windows\character_sheet.cc:82`<br>`features\windows\chat_window.cc:63`<br>`features\windows\craft_atlas.cc:32`<br>`features\windows\inventory_viewer.cc:52`<br>`features\windows\make_item_window.cc:218`<br>`features\windows\npc_shop_window.cc:76`<br>… +2 | std::list<ItemSkillInfo> (session+0x16f0) |
| `0x015fbab4` | kInvCount | `features\windows\character_sheet.cc:83`<br>`features\windows\inventory_viewer.cc:53` | _Mysize |
| `0x015fbad8` | kStorageListHead | `features\windows\storage_window.cc:115`<br>`features\windows\storage_window.cc:831` |  |
...
| `0x015ff804` | kInPartyFlag | `features\windows\entity_context_menu.cc:152` |  |
| `0x015ff838` | kInputTargetMode | `features\windows\chat_window.cc:125` | 0 public 1 groupe 2 guilde 3 clan 4 alliés |
| `0x015ff908` | kHp | `features\overlays\basic_info.cc:70`<br>`features\windows\character_sheet.cc:97` |  |
| `0x015ff90c` | kHp | `features\overlays\basic_info.cc:70`<br>`features\windows\character_sheet.cc:97` |  |
| `0x015ff910` | kOwnSpCur, kSp | `features\overlays\basic_info.cc:71`<br>`features\windows\character_sheet.cc:98`<br>`features\windows\weapon_refine_window.cc:86` |  |
| `0x015ff914` | kSp | `features\overlays\basic_info.cc:71`<br>`features\windows\character_sheet.cc:98` |  |
...
| `0x015ffd14` | kShowEquipFlag | `features\windows\character_sheet.cc:132` | 1 = équip visible des autres (validé live) |
...
| `0x015fffa1` | kSafeCheckFlag | `features\windows\vending_window.cc:409` | octet, persistant |
| `0x015fffc0` | kBankVault | `features\windows\bank_window.cc:37` | s64 |
| `0x016004fc` | kOwnTitleId | `features\windows\character_sheet.cc:2042` | g_Own_TitleId : titre ÉQUIPÉ (0 = aucun) |
| `0x01600500` | kOwnTitleBegin | `features\windows\character_sheet.cc:2043` | std::vector<int> g_OwnTitleList : begin (possédés) |
| `0x01600504` | kOwnTitleEnd | `features\windows\character_sheet.cc:2044` | .. end |
...
| `0x016023e4` | kSnapName | `features\windows\vending_window.cc:303` | std::string : nom de la boutique |
| `0x01602400` | kSnapBegin | `features\windows\vending_window.cc:301` | vecteur d'ItemSkillInfo |
| `0x01602404` | kSnapEnd | `features\windows\vending_window.cc:302` |  |
| `0x016024c0` | kCostumeHideFlag | `features\windows\character_sheet.cc:133` | 0 = costumes affichés (validé live) |
