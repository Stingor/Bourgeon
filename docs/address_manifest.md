...
- **766 adresses distinctes**, 1039 sites
- ⚓ 51 portées par l'annuaire (`ragnarok/*.h`, `ui/game_texture.h`)
- 114 présentes dans plusieurs fichiers (candidates annuaire si cohérentes)

| Adresse | Nom(s) | Sites | Commentaire |
|---|---|---|---|
| `0x00420000` | kSyntheticKeyLParam | `ragnarok\ragnarok_client.cc:59` |  |
| `0x004e52a0` | kStdStringCopyCtor | `features\windows\chat_window.cc:453` | __thiscall(dst, src), retn 4 |
...
| `0x005a1460` | kCNameDict_GetEntryOrRequest, kNameDictGetEntry, kNameDictGetEntryOrRequest | `features\overlays\entity_names.cc:32`<br>`features\windows\chat_window.cc:1013`<br>`features\windows\entity_context_menu.cc:94`<br>`features\windows\entity_inspector.cc:41`<br>`features\windows\vending_window.cc:289` | __thiscall(dict, gid) |
...
| `0x005c8950` | kEmblemRequestUpload | `features\windows\character_sheet.cc:1538` | __thiscall(this, guildId, std::string) |
...
| `0x006060ff` | (littéral) | `features\windows\chat_window.cc:7172` |  |
| `0x0060c820` | (littéral) | `ragnarok\configuration.h:13` |  |
| `0x00613100` | (littéral) | `ragnarok\configuration.h:14` |  |
| `0x0061d370` | kGetEmblemPath | `features\windows\character_sheet.cc:1215` | __thiscall(this, out_str, guildId) |
| `0x0061d560` | kGetEmblemVersion | `features\windows\character_sheet.cc:1307` | __thiscall(this, guildId) -> version |
...
| `0x00738370` | kSkillGetTabList | `features\windows\character_sheet.cc:1011`<br>`features\windows\weapon_refine_window.cc:182`<br>`ragnarok\player_skills.cc:13` | __thiscall(bundle, tab) -> std::list* |
| `0x00738570` | kSkillSetUseLevel | `features\windows\character_sheet.cc:1012` | __thiscall(bundle, id, lv) |
| `0x00739cd0` | kSkillEntryDtor, kSkillInfoDtor | `features\overlays\skill_bar.cc:673`<br>`features\windows\character_sheet.cc:138`<br>`ragnarok\homunculus.cc:66` | = FUN_00739cd0 (cleanup de la struct) |
| `0x0073a140` | kGetSkillIdNameLua | `features\overlays\skill_bar.cc:564`<br>`features\windows\character_sheet.cc:183` | char* GetSkillIdName(int) __cdecl |
| `0x0073a1f0` | kGetSkillNameLua | `features\overlays\cast_bar.cc:35`<br>`features\overlays\skill_bar.cc:97`<br>`features\windows\character_sheet.cc:2476`<br>`features\windows\craft_atlas.cc:43`<br>`features\windows\monster_info_window.cc:393` | char* GetSkillName(int id) (__cdecl, via Lua) |
| `0x0073adb0` | kIsLevelUseSkill | `features\windows\character_sheet.cc:1014` | __cdecl(id) : l'effet dépend-il du niveau ? |
...
| `0x007a7fa0` | kStdVectorIntPushBack | `features\windows\entity_context_menu.cc:92` | __thiscall(vec*, int*) |
...
| `0x008c18b0` | kItemDescWndAddr | `features\moonlight_ui\moonlight_ui.h:336` |  |
...
| `0x008dc0d0` | kChatToggleInputBar | `features\windows\chat_window.cc:491` | __thiscall(this), retn 0 |
| `0x008e1730` | kChatTagTransform | `features\windows\chat_window.cc:452` | __thiscall(this, out, in), retn 8 |
...
| `0x0095dfb0` | kBILayoutChildren | `features\overlays\basic_info.cc:2738` | __thiscall(wnd, height) |
...
| `0x009b9b9b` | (littéral) | `features\windows\chat_window.cc:5651` | COLORREF gris, comme les en-têtes du client |
...
| `0x00a2c600` | kFriendListAddByName | `features\windows\chat_window.cc:205` |  |
| `0x00a2cc20` | kWhisperPivotAddr | `features\windows\chat_window.cc:562` |  |
...
| `0x00a388f0` | kFriendListContains | `features\windows\entity_context_menu.cc:100` | __thiscall(mgr, name) |
...
| `0x00a69eb0` | kActorListFindByGid, kFindByGID | `features\gameplay\player_jump.cc:18`<br>`features\windows\entity_context_menu.cc:96` | ActorList_FindByGID(actorMgr,gid)->acteur |
| `0x00a727f0` | kActiveIdSetContains | `features\windows\entity_context_menu.cc:93` | __cdecl(aid) -> bool |
| `0x00a74410` | kCursorRenderFn | `ragnarok\ragnarok_client.cc:83` | CursorMgr_RenderSprite |
| `0x00a75340` | ⚓ kModeMgrGetActiveAddr | `ragnarok\globals.h:138` |  |
...
| `0x00a797b0` | kQuadTreeQuery, kQuadTreeQueryPointAddr | `features\gameplay\quick_cast.cc:26`<br>`features\windows\char_diagnostics.cc:463` |  |
...
| `0x00a94930` | kStdStringFromFmt | `features\windows\character_sheet.cc:1539` | (dst, fmt, …) -> std::string du jeu |
...
| `0x00c6e990` | kShowEntityContextMenu | `features\windows\entity_context_menu.cc:34` |  |
...
| `0x00c753a0` | kPostActorClickAction | `features\windows\entity_context_menu.cc:95` | __thiscall(gm, aid, flag) |
| `0x00c756a0` | kRouteHoverAndClick | `features\windows\entity_context_menu.cc:43` |  |
| `0x00c7a7eb` | kPartyPrefixByte | `features\windows\chat_window.cc:778` |  |
| `0x00c7a822` | kGuildPrefixByte | `features\windows\chat_window.cc:779` |  |
| `0x00c7a89a` | kAllyPrefixByte | `features\windows\chat_window.cc:780` |  |
...
| `0x00ca0c5d` | (littéral) | `bourgeon.cc:175` |  |
| `0x00caa2e0` | (littéral) | `ragnarok\configuration.h:89` |  |
| `0x00cb13c6` | (littéral) | `bourgeon.cc:175` |  |
...
| `0x00d5b580` | kGetJob | `features\overlays\basic_info.cc:135`<br>`features\overlays\basic_info.cc:1154`<br>`features\overlays\basic_info.cc:1367`<br>`features\windows\character_sheet.cc:820`<br>`features\windows\character_sheet.cc:2512`<br>`features\windows\palette_editor.cc:40` |  |
| `0x00d5bb40` | kJobDisplayName, kJobNameAddr, kJobResName | `features\overlays\basic_info.cc:137`<br>`features\windows\char_diagnostics.cc:96`<br>`features\windows\char_select.cc:398`<br>`features\windows\character_sheet.cc:822`<br>`features\windows\character_sheet.cc:835`<br>`features\windows\entity_inspector.cc:47`<br>… +3 | __thiscall(ctx, classId, sex) |
...
| `0x00d5e3c0` | kSkillGetUseLevel | `features\windows\character_sheet.cc:1013` | __thiscall(SESSION, id) — même tableau |
...
| `0x00d715f0` | kFriendListHasName | `features\windows\chat_window.cc:189` |  |
...
| `0x00d7fa90` | kGetInvItemAddr, kSkillEntryFill | `features\overlays\skill_bar.cc:257`<br>`features\overlays\skill_bar.cc:600`<br>`features\overlays\skill_bar.cc:671`<br>`features\windows\character_sheet.cc:137` | __stdcall(out, id) |
| `0x00d7fd30` | (littéral) | `features\windows\char_select.cc:994` |  |
| `0x00d7fe40` | kOwnGetCharName | `features\windows\chat_window.cc:576` | __thiscall(ctxKey) -> char* |
...
| `0x00d89ed0` | kTitleGetStr | `features\windows\character_sheet.cc:2124` |  |
...
| `0x00d99860` | kAdoptionEligible | `features\windows\entity_context_menu.cc:129` | __stdcall(aid) -> bool |
| `0x00d99ca0` | kJobGetMaxBaseLevel | `features\overlays\basic_info.cc:2700` | __stdcall(jobId) |
| `0x00d99d30` | kJobGetMaxJobLevel | `features\overlays\basic_info.cc:2701` | __stdcall(jobId) |
...
| `0x00d9d220` | kIsHostileOrSpecial | `features\windows\entity_context_menu.cc:133` | __stdcall(aid, job) -> bool |
...
| `0x00dbbc7f` | ⚓ kGameOperatorDeleteAddr | `ragnarok\globals.h:198` | __cdecl(ptr) |
| `0x00e8ddb6` | kWhisperRecvRgb | `features\windows\chat_window.cc:569` | reçu : bleu-gris pâle |
...
| `0x00ff00ff` | kEmblemClear | `features\minigames\roggle.cc:269`<br>`features\windows\character_sheet.cc:1627` | magenta pur = transparent en jeu |
| `0x00ffaa00` | kOwnChatRgb | `features\overlays\dps_meter.cc:194`<br>`features\windows\entity_context_menu.cc:56` |  |
| `0x00ffd070` | (littéral) | `features\windows\chat_window.cc:1608` |  |
| `0x00ffe060` | (littéral) | `features\overlays\quest_tracker.h:18` | hunt progress lines ("mob ( x / y )") |
| `0x00ffff00` | (littéral) | `features\windows\character_sheet.cc:1478` |  |
...
| `0x0103e35c` | kBIMsgSlot | `features\overlays\basic_info.cc:2622` | vtable+0x94 OnMsg slot |
...
| `0x011e40d4` | kMouseScreenX, kMouseScreenXAddr | `features\gameplay\quick_cast.cc:37`<br>`features\windows\char_diagnostics.cc:464`<br>`ragnarok\ragnarok_client.cc:167` |  |
| `0x011e40d8` | kMouseScreenY, kMouseScreenYAddr | `features\gameplay\quick_cast.cc:38`<br>`features\windows\char_diagnostics.cc:465`<br>`ragnarok\ragnarok_client.cc:168` |  |
| `0x011e40e4` | kMouseLButtonState | `features\windows\entity_context_menu.cc:62` |  |
| `0x011e40e8` | kMouseRButtonState | `features\windows\entity_context_menu.cc:63` |  |
...
| `0x01213338` | ⚓ kModeMgrAddr | `ragnarok\globals.h:49` |  |
...
| `0x012135f0` | kNameplateQuadTreeAddr, kPickQuadTree | `features\gameplay\quick_cast.cc:27`<br>`features\windows\char_diagnostics.cc:462` |  |
| `0x01228f60` | kMotionSpeedCap | `features\windows\char_diagnostics.cc:81` | g_MotionSpeedCapMs |
| `0x012291c0` | (littéral) | `features\fx\screen_fx.cc:417` | g_cam_zoomMaxOutdoor |
...
| `0x0125161c` | kSpriteCache, kSpriteTexCacheAddr | `features\overlays\status_icon_bar.cc:49`<br>`ragnarok\game_settings.cc:166` | &DAT_0125161c (sprite-ref cache) |
| `0x01251668` | kSaveJsonSelf | `ragnarok\emotion_hotkey.cc:44` |  |
| `0x012517b8` | kEmblemDataMgrPtr | `features\windows\character_sheet.cc:1537` | *ptr = CEmblemDataMgr |
| `0x01251824` | kChatBlockListPtr | `features\windows\entity_context_menu.cc:115` |  |
...
| `0x01254d70` | kCGuildMgrPtr | `features\windows\character_sheet.cc:1214` | *ptr = g_CGuildMgr (CGuildEmblemMgr) |
...
| `0x0131f4e8` | ⚓ kUIWindowMgr, kUIWindowMgrAddr, kUiWindowMgr | `features\overlays\chat_balloon.cc:49`<br>`features\windows\entity_context_menu.cc:101`<br>`features\windows\navigation_window.cc:67`<br>`ragnarok\uiwnd.h:25` | g_UIWindowMgr (l'OBJET, pas un pointeur vers lui) |
| `0x0131f50e` | kBattleModeFlag, kChangeChatModeAddr | `features\windows\chat_window.cc:490`<br>`features\windows\hotkey_settings.cc:57` |  |
...
| `0x0131f6c4` | kBasicInfoPtr | `features\overlays\basic_info.cc:2874` | 0x0131f4e8 + 0x1dc |
| `0x0131f700` | kItemDescWndGlobalPtr, kItemWndSlot | `features\moonlight_ui\moonlight_ui.h:344`<br>`features\windows\item_desc_window.cc:48` | mgr+0x218 : ITEM desc (classe 0xc) |
...
| `0x0131f770` | ⚓ kStorageWndPtr, kStorageWndSlot | `features\windows\entity_context_menu.cc:72`<br>`ragnarok\uiwnd.h:101` | storage NATIF ouvert |
...
| `0x0159c188` | kGuildBuf, kGuildObj | `features\patches\status_tweaks.cc:117`<br>`features\windows\character_sheet.cc:420` | std::string buffer/ptr union |
...
| `0x0159c1a0` | kGuildMasterName | `features\windows\character_sheet.cc:436` | std::string : nom du maître |
| `0x0159c1b8` | kGuildNoticeSubj | `features\windows\character_sheet.cc:443` | std::string : sujet de l'annonce (ZC 0x016f) |
| `0x0159c1d0` | kGuildNoticeBody | `features\windows\character_sheet.cc:444` | std::string : corps de l'annonce |
| `0x0159c1e8` | kGuildLevel | `features\windows\character_sheet.cc:422` |  |
| `0x0159c1f0` | kGuildOnlineNum | `features\windows\character_sheet.cc:437` | connect_member (membres en ligne) |
| `0x0159c1f4` | kGuildMemberMax | `features\windows\character_sheet.cc:438` | max_member |
| `0x0159c1f8` | kGuildAvgLevel | `features\windows\character_sheet.cc:439` | niveau moyen |
| `0x0159c1fc` | kGuildManageLand | `features\windows\character_sheet.cc:440` | std::string : territoire (nb de forts) |
| `0x0159c214` | kGuildExp | `features\windows\character_sheet.cc:441` | exp courante |
| `0x0159c218` | kGuildNextExp | `features\windows\character_sheet.cc:442` | exp du niveau suivant |
| `0x0159c230` | kGuildIdAddr, kOwnGuildId | `features\windows\character_sheet.cc:424`<br>`features\windows\chat_window.cc:128`<br>`features\windows\entity_context_menu.cc:153`<br>`ragnarok\emotion_hotkey.cc:53` |  |
| `0x0159c23c` | kGuildIsMaster | `features\windows\character_sheet.cc:423`<br>`features\windows\entity_context_menu.cc:154` |  |
| `0x0159c26c` | kGuildRelHead | `features\windows\character_sheet.cc:445` | CGuild+0xe4 : liste alliés/ennemis |
...
| `0x015beecc` | kReplayActive | `features\windows\entity_context_menu.cc:71`<br>`ragnarok\skill_cooldowns.cc:23` | lecture d'un replay |
...
| `0x015fa3c0` | ⚓ kJobNameCtx, kOptionContextAddr, kSessionAddr, kUIWindowContextKey, kUiCtx | `features\windows\chat_window.cc:119`<br>`features\windows\entity_context_menu.cc:157`<br>`ragnarok\emotion_hotkey.cc:20`<br>`ragnarok\game_settings.cc:209`<br>`ragnarok\globals.h:26`<br>`ragnarok\homunculus.cc:67`<br>… +1 | la session |
| `0x015fa3cc` | kSkillBundle | `features\windows\character_sheet.cc:1009`<br>`features\windows\weapon_refine_window.cc:180`<br>`ragnarok\player_skills.cc:11` | CPlayerSkillBundle (session+0x0C) |
| `0x015fa3e0` | kSkillFlatList | `features\windows\character_sheet.cc:1010`<br>`features\windows\weapon_refine_window.cc:181`<br>`ragnarok\player_skills.cc:12` | bundle+0x14 : l'onglet « divers » |
...
| `0x015fb2f8` | kFriendOptOpenFromStranger | `features\windows\chat_window.cc:182` |  |
| `0x015fb2fc` | kFriendOptAlarm1on1 | `features\windows\chat_window.cc:183` |  |
| `0x015fb300` | kFriendOptOpenFromFriend | `features\windows\chat_window.cc:184` |  |
...
| `0x015fb3b0` | kAid, kOwnPetAid | `features\windows\entity_context_menu.cc:156`<br>`ragnarok\pet.cc:19` |  |
...
| `0x015fb9a4` | kAccountAid, kOwnAccountAid, kOwnAccountId, kOwnAid, kOwnAidAddr, kOwnHandlePtr | `features\fx\ez_effect_capture.cc:44`<br>`features\fx\style_sync.cc:24`<br>`features\gameplay\quick_cast.cc:41`<br>`features\overlays\basic_info.cc:162`<br>`features\windows\char_diagnostics.cc:35`<br>`features\windows\char_select.cc:213`<br>… +5 | handle/AID du joueur |
| `0x015fb9a8` | kOwnCharId, kOwnCharIdAddr, kOwnCid | `features\hotkey_util.cc:24`<br>`features\fx\style_sync.cc:28`<br>`features\windows\char_diagnostics.cc:36`<br>`features\windows\character_sheet.cc:87`<br>`features\windows\palette_editor.cc:50` | g_Own_CharId (cf. project_own_session_globals) |
...
| `0x015fb9d8` | kBaseExpNextLo, kOwnBaseExpNext | `features\overlays\basic_info.cc:77`<br>`features\overlays\basic_info.cc:2702`<br>`features\windows\char_diagnostics.cc:49` | g_Own_BaseExpNext (INT64) |
| `0x015fb9e0` | kJobExpNextLo, kOwnJobExpNext | `features\overlays\basic_info.cc:78`<br>`features\overlays\basic_info.cc:2703`<br>`features\windows\char_diagnostics.cc:50` | g_Own_JobExpNext  (INT64) |
| `0x015fb9e8` | kJobExpLo | `features\overlays\basic_info.cc:78`<br>`features\windows\char_diagnostics.cc:51` |  |
| `0x015fb9f0` | ⚓ kBaseLevel, kBaseLevelAddr, kBaseLvl | `features\overlays\basic_info.cc:122`<br>`features\windows\character_sheet.cc:102`<br>`ragnarok\globals.h:171` | DAT_015fb9f0 (UIBasicInfoWnd "Base Lv.") |
| `0x015fb9f4` | kStatusPoint, kStatusPt | `features\patches\status_tweaks.cc:114`<br>`features\windows\char_diagnostics.cc:39`<br>`features\windows\character_sheet.cc:95` | g_Own_StatusPoints |
| `0x015fb9f8` | ⚓ kBaseLvl, kJobLevel, kJobLevelAddr, kOwnJobLevel | `features\overlays\basic_info.cc:123`<br>`features\windows\character_sheet.cc:102`<br>`features\windows\weapon_refine_window.cc:70`<br>`ragnarok\globals.h:172` | DAT_015fb9f8 (UIBasicInfoWnd "Job Lv.") |
| `0x015fb9fc` | kSkillPoint, kSkillPointLvl, kSkillPointsAddr | `features\patches\skill_tree_tweaks.cc:42`<br>`features\windows\char_diagnostics.cc:40`<br>`features\windows\character_sheet.cc:1015` | changes when points are spent |
| `0x015fba04` | kSkillPts | `ragnarok\homunculus.cc:37` |  |
| `0x015fba0c` | ⚓ kStatBonus, kStatBonusAddr | `features\patches\status_tweaks.cc:103`<br>`features\windows\char_diagnostics.cc:58`<br>`features\windows\character_sheet.cc:93`<br>`ragnarok\globals.h:154` | bonus |
...
| `0x015fba24` | ⚓ kStatBase, kStatBaseAddr | `features\patches\status_tweaks.cc:101`<br>`features\windows\char_diagnostics.cc:57`<br>`features\windows\character_sheet.cc:92`<br>`ragnarok\globals.h:153` | STR..LUK, pas de 4 |
...
| `0x015fba3c` | kRaiseCost, kStatCost | `features\patches\status_tweaks.cc:105`<br>`features\windows\char_diagnostics.cc:59`<br>`features\windows\character_sheet.cc:94` | coût de la prochaine montée |
...
| `0x015fba54` | kAspdRaw, kAttackDelay, kFlee | `features\patches\status_tweaks.cc:113`<br>`features\windows\char_diagnostics.cc:71`<br>`features\windows\character_sheet.cc:101` |  |
| `0x015fba58` | kAtk1 | `features\patches\status_tweaks.cc:107`<br>`features\windows\char_diagnostics.cc:60`<br>`features\windows\character_sheet.cc:96` |  |
| `0x015fba5c` | kMdefSoft | `features\patches\status_tweaks.cc:109`<br>`features\windows\char_diagnostics.cc:63`<br>`features\windows\character_sheet.cc:99` |  |
| `0x015fba64` | kDefSoft | `features\patches\status_tweaks.cc:108`<br>`features\windows\char_diagnostics.cc:61`<br>`features\windows\character_sheet.cc:97` |  |
| `0x015fba68` | kDefSoft | `features\patches\status_tweaks.cc:108`<br>`features\windows\char_diagnostics.cc:61`<br>`features\windows\character_sheet.cc:97` |  |
| `0x015fba6c` | kAtk1 | `features\patches\status_tweaks.cc:107`<br>`features\windows\char_diagnostics.cc:60`<br>`features\windows\character_sheet.cc:96` |  |
| `0x015fba70` | kMatkMax, kMatkMin | `features\patches\status_tweaks.cc:110`<br>`features\windows\char_diagnostics.cc:62`<br>`features\windows\character_sheet.cc:98` |  |
| `0x015fba74` | kMatkMax, kMatkMin | `features\patches\status_tweaks.cc:110`<br>`features\windows\char_diagnostics.cc:62`<br>`features\windows\character_sheet.cc:98` |  |
| `0x015fba78` | kMdefSoft | `features\patches\status_tweaks.cc:109`<br>`features\windows\char_diagnostics.cc:63`<br>`features\windows\character_sheet.cc:99` |  |
| `0x015fba7c` | kHit, kOwnHit | `features\patches\status_tweaks.cc:111`<br>`features\windows\char_diagnostics.cc:64`<br>`features\windows\character_sheet.cc:100`<br>`features\windows\monster_info_window.cc:319` |  |
| `0x015fba80` | kFlee, kHit, kOwnFlee | `features\patches\status_tweaks.cc:112`<br>`features\windows\char_diagnostics.cc:64`<br>`features\windows\character_sheet.cc:101`<br>`features\windows\monster_info_window.cc:320` |  |
| `0x015fba84` | kCrit, kHit, kOwnCrit | `features\patches\status_tweaks.cc:111`<br>`features\windows\char_diagnostics.cc:65`<br>`features\windows\character_sheet.cc:100`<br>`features\windows\monster_info_window.cc:321` |  |
| `0x015fba88` | kCrit, kFlee, kOwnPdodge | `features\patches\status_tweaks.cc:112`<br>`features\windows\char_diagnostics.cc:65`<br>`features\windows\character_sheet.cc:101`<br>`features\windows\monster_info_window.cc:322` |  |
| `0x015fba8c` | kAmmoInvIndex | `features\windows\character_sheet.cc:118` | g_AmmoEquippedInvIndex (0 = aucune) |
...
| `0x015fbab0` | kInvListHead | `features\windows\character_sheet.cc:88`<br>`features\windows\chat_window.cc:65`<br>`features\windows\craft_atlas.cc:32`<br>`features\windows\inventory_viewer.cc:52`<br>`features\windows\make_item_window.cc:218`<br>`features\windows\npc_shop_window.cc:76`<br>… +3 | std::list<ItemSkillInfo> (session+0x16f0) |
| `0x015fbab4` | kInvCount | `features\windows\character_sheet.cc:89`<br>`features\windows\inventory_viewer.cc:53` | _Mysize |
...
| `0x015ff804` | kInPartyFlag | `features\windows\entity_context_menu.cc:155` |  |
...
| `0x015ff908` | kHp | `features\overlays\basic_info.cc:79`<br>`features\windows\char_diagnostics.cc:44`<br>`features\windows\character_sheet.cc:103` |  |
| `0x015ff90c` | kHp, kHpMax | `features\overlays\basic_info.cc:79`<br>`features\windows\char_diagnostics.cc:45`<br>`features\windows\character_sheet.cc:103` |  |
| `0x015ff910` | kOwnSpCur, kSp | `features\overlays\basic_info.cc:80`<br>`features\windows\char_diagnostics.cc:46`<br>`features\windows\character_sheet.cc:104`<br>`features\windows\weapon_refine_window.cc:86` |  |
| `0x015ff914` | kSp, kSpMax | `features\overlays\basic_info.cc:80`<br>`features\windows\char_diagnostics.cc:47`<br>`features\windows\character_sheet.cc:104` |  |
...
| `0x015ffd14` | kShowEquipFlag | `features\windows\character_sheet.cc:143` | 1 = équip visible des autres (validé live) |
...
| `0x016004fc` | kOwnTitleId | `features\windows\character_sheet.cc:2119` | g_Own_TitleId : titre ÉQUIPÉ (0 = aucun) |
| `0x01600500` | kOwnTitleBegin | `features\windows\character_sheet.cc:2120` | std::vector<int> g_OwnTitleList : begin (possédés) |
| `0x01600504` | kOwnTitleEnd | `features\windows\character_sheet.cc:2121` | .. end |
...
| `0x016024c0` | kCostumeHideFlag | `features\windows\character_sheet.cc:144` | 0 = costumes affichés (validé live) |
