...
const moonlight_ui::SettingDesc kItemObtainToastSettings[] = {
    // 🔴 Clé RENOMMÉE (ex-`itemtoast_enabled`) pour imposer le nouveau défaut OFF
    // aux yaml déjà écrits ; cf. le commentaire du champ dans item_obtain_toast.h.
    {"itemtoast_replace_native", SType::kBool, IOTOAST(enabled)},
    ...
    {"itemtoast_locked",         SType::kBool, IOTOAST(locked)},
    {"itemtoast_pos_x",          SType::kInt,  IOTOAST(pos_x)},
    {"itemtoast_pos_y",          SType::kInt,  IOTOAST(pos_y)},
    {"itemtoast_row_gap",        SType::kInt,  IOTOAST(row_gap)},
    {"itemtoast_pad_v",          SType::kInt,  IOTOAST(pad_v)},
    {"itemtoast_show_icon",      SType::kBool, IOTOAST(show_icon)},
    {"itemtoast_show_frame",     SType::kBool, IOTOAST(show_frame)},
    {"itemtoast_bg_enabled",     SType::kBool, IOTOAST(bg_enabled)},
    {"itemtoast_bg_rgb",         SType::kInt,  IOTOAST(bg_rgb)},
    {"itemtoast_bg_alpha",       SType::kInt,  IOTOAST(bg_alpha)},
    {"itemtoast_bg_rounding",    SType::kInt,  IOTOAST(bg_rounding)},
    {"itemtoast_border_on",      SType::kBool, IOTOAST(border_enabled)},
    {"itemtoast_border_rgb",     SType::kInt,  IOTOAST(border_rgb)},
    {"itemtoast_border_alpha",   SType::kInt,  IOTOAST(border_alpha)},
    {"itemtoast_border_thick",   SType::kInt,  IOTOAST(border_thickness)},
...
const moonlight_ui::SettingDesc kGraphicsSettings[] = {
    ...
    {"fps_shadow",        SType::kBool,  MLUI_FIELD(screen_fx, fps_shadow()),
     MLUI_LITERAL(bool, true)},
    {"fps_show_ping",     SType::kBool,  MLUI_FIELD(screen_fx, fps_show_ping()),
     MLUI_LITERAL(bool, true)},
    {"fps_scale",         SType::kFloat, MLUI_FIELD(screen_fx, fps_scale()),
     MLUI_LITERAL(float, 1.0f)},
...
const moonlight_ui::SettingDesc kPartyFramesSettings[] = {
    ...
    {"partyframes_sp_h", SType::kInt, MLUI_FIELD(party_frames, sp_bar_h()),
     MLUI_LITERAL(int, 6)},
    {"partyframes_buffs", SType::kBool, MLUI_FIELD(party_frames, show_buffs_),
     MLUI_LITERAL(bool, true)},
    {"partyframes_buff_px", SType::kInt, MLUI_FIELD(party_frames, buff_px()),
     MLUI_LITERAL(int, 14)},
...
const moonlight_ui::SettingDesc kPartyFriendSettings[] = {
    ...
    {"partyfriend_tab", SType::kInt, MLUI_FIELD(party_friend_window, cur_tab()),
     MLUI_LITERAL(int, 1)},
    {"partyfriend_lock_size", SType::kBool,
     MLUI_FIELD(party_friend_window, lock_size()), MLUI_LITERAL(bool, false)},
    ...
    {"partyfriend_head_mode", SType::kInt,
     MLUI_FIELD(party_friend_window, head_mode_), MLUI_LITERAL(int, 0)},
    ...
    {"partyfriend_buffs", SType::kBool,
     MLUI_FIELD(party_friend_window, show_buffs_), MLUI_LITERAL(bool, false)},
    {"partyfriend_buff_px", SType::kInt,
     MLUI_FIELD(party_friend_window, buff_px()), MLUI_LITERAL(int, 16)},
    {"partyfriend_buff_max", SType::kInt,
     MLUI_FIELD(party_friend_window, buff_max()), MLUI_LITERAL(int, 8)},
...
const moonlight_ui::SettingDesc kOptInWindowSettings[] = {
    ...
    {"target_cast_on_target", SType::kBool,
     MLUI_FIELD(target_frame, cast_on_target_), MLUI_LITERAL(bool, false)},
    {"target_proxy_click", SType::kBool,
     MLUI_FIELD(target_frame, proxy_click_), MLUI_LITERAL(bool, false)},
