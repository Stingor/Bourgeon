...
#include "plugins/ez_effect_capture.h"  // capture PARTAGÉE des effets EZ (doll + aperçu)
...
// sommet) vit désormais dans le module PARTAGÉ `ez_capture` (plugins/ez_effect_capture.h).
