...
static const Blob kTabhLOn = { 5, 20 };
static const Blob kTabhMOn = { 5, 20 };
static const Blob kTabhROn = { 5, 20 };
static const Blob kTabhLOff = { 5, 20 };
static const Blob kTabhMOff = { 5, 20 };
static const Blob kTabhROff = { 5, 20 };
