...
#define PROXY1(name) \
  { return m_Instance->name(p1); }
#define PROXY2(name) \
  { return m_Instance->name(p1, p2); }
#define PROXY3(name) \
  { return m_Instance->name(p1, p2, p3); }
#define PROXY4(name) \
  { return m_Instance->name(p1, p2, p3, p4); }
#define PROXY5(name) \
  { return m_Instance->name(p1, p2, p3, p4, p5); }
#define PROXY6(name) \
  { return m_Instance->name(p1, p2, p3, p4, p5, p6); }
#define PROXY7(name) \
  { return m_Instance->name(p1, p2, p3, p4, p5, p6, p7); }
...
class CProxyIDirectDraw7 final : public IDirectDraw7 {
 ...
 public:
  ...
  (THIS_ DWORD p1, LPDIRECTDRAWCLIPPER FAR *p2, IUnknown FAR *p3)
      PROXY3(CreateClipper);
  STDMETHOD(CreatePalette)
  (THIS_ DWORD p1, LPPALETTEENTRY p2, LPDIRECTDRAWPALETTE FAR *p3,
   IUnknown FAR *p4) PROXY4(CreatePalette);
  STDMETHOD(CreateSurface)
  (THIS_ LPDDSURFACEDESC2 p1, LPDIRECTDRAWSURFACE7 FAR *p2, IUnknown FAR *p3) {
    return Proxy_CreateSurface(p1, p2, p3);
  }
  STDMETHOD(DuplicateSurface)
  (THIS_ LPDIRECTDRAWSURFACE7 p1, LPDIRECTDRAWSURFACE7 FAR *p2)
      PROXY2(DuplicateSurface);
  STDMETHOD(EnumDisplayModes)
  (THIS_ DWORD p1, LPDDSURFACEDESC2 p2, LPVOID p3, LPDDENUMMODESCALLBACK2 p4)
      PROXY4(EnumDisplayModes);
  STDMETHOD(EnumSurfaces)
  (THIS_ DWORD p1, LPDDSURFACEDESC2 p2, LPVOID p3, LPDDENUMSURFACESCALLBACK7 p4)
      PROXY4(EnumSurfaces);
  STDMETHOD(FlipToGDISurface)
  (THIS) PROXY0(FlipToGDISurface);
  ...
  (THIS_ LPDWORD p1, LPDWORD p2) PROXY2(GetFourCCCodes);
  STDMETHOD(GetGDISurface)
  (THIS_ LPDIRECTDRAWSURFACE7 FAR *p1) PROXY1(GetGDISurface);
  STDMETHOD(GetMonitorFrequency)
  (THIS_ LPDWORD p1) PROXY1(GetMonitorFrequency);
  STDMETHOD(GetScanLine)(THIS_ LPDWORD p1) PROXY1(GetScanLine);
  STDMETHOD(GetVerticalBlankStatus)
  (THIS_ LPBOOL p1) PROXY1(GetVerticalBlankStatus);
  ...
  (THIS_ DWORD p1, DWORD p2, DWORD p3, DWORD p4, DWORD p5) {
  ...
  STDMETHOD(GetAvailableVidMem)
  (THIS_ LPDDSCAPS2 p1, LPDWORD p2, LPDWORD p3) PROXY3(GetAvailableVidMem);

  /*** Added in the V4 Interface ***/
  STDMETHOD(GetSurfaceFromDC)
  (THIS_ HDC p1, LPDIRECTDRAWSURFACE7 *p2) PROXY2(GetSurfaceFromDC);
  STDMETHOD(RestoreAllSurfaces)(THIS) { return Proxy_RestoreAllSurfaces(); }
  STDMETHOD(TestCooperativeLevel)
  (THIS) PROXY0(TestCooperativeLevel);
  STDMETHOD(GetDeviceIdentifier)
  (THIS_ LPDDDEVICEIDENTIFIER2 p1, DWORD p2) PROXY2(GetDeviceIdentifier);

  /*** Added in the V7 Interface ***/
  STDMETHOD(StartModeTest)
  (THIS_ LPSIZE p1, DWORD p2, DWORD p3) PROXY3(StartModeTest);
  ...
  HRESULT Proxy_CreateSurface(LPDDSURFACEDESC2 p1, LPDIRECTDRAWSURFACE7 FAR *p2,
                              IUnknown FAR *p3);
  HRESULT Proxy_GetDisplayMode(LPDDSURFACEDESC2 p1);
  HRESULT Proxy_SetCooperativeLevel(HWND p1, DWORD p2);
  HRESULT Proxy_SetDisplayMode(DWORD p1, DWORD p2, DWORD p3, DWORD p4,
                               DWORD p5);
...
class CProxyIDirectDrawSurface7 final : public IDirectDrawSurface7 {
 ...
 public:
  ...
  (THIS_ REFIID p1, LPVOID FAR *p2) PROXY2(QueryInterface);
  ...
  (THIS_ LPDIRECTDRAWSURFACE7 p1) PROXY1(AddAttachedSurface);
  STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT p1) PROXY1(AddOverlayDirtyRect);

  STDMETHOD(Blt)
  (THIS_ LPRECT p1, LPDIRECTDRAWSURFACE7 p2, LPRECT p3, DWORD p4, LPDDBLTFX p5)
      PROXY5(Blt);
  STDMETHOD(BltBatch)
  (THIS_ LPDDBLTBATCH p1, DWORD p2, DWORD p3) PROXY3(BltBatch);
  STDMETHOD(BltFast)
  (THIS_ DWORD p1, DWORD p2, LPDIRECTDRAWSURFACE7 p3, LPRECT p4, DWORD p5)
      PROXY5(BltFast);

  STDMETHOD(DeleteAttachedSurface)
  (THIS_ DWORD p1, LPDIRECTDRAWSURFACE7 p2) PROXY2(DeleteAttachedSurface);
  STDMETHOD(EnumAttachedSurfaces)
  (THIS_ LPVOID p1, LPDDENUMSURFACESCALLBACK7 p2) PROXY2(EnumAttachedSurfaces);
  ...
  STDMETHOD(GetBltStatus)
  (THIS_ DWORD p1) PROXY1(GetBltStatus) STDMETHOD(GetCaps)(THIS_ LPDDSCAPS2 p1)
      PROXY1(GetCaps);
  ...
  STDMETHOD(GetOverlayPosition)
  (THIS_ LPLONG p1, LPLONG p2) PROXY2(GetOverlayPosition);
  STDMETHOD(GetPalette)
  (THIS_ LPDIRECTDRAWPALETTE FAR *p1) PROXY1(GetPalette)
      STDMETHOD(GetPixelFormat)(THIS_ LPDDPIXELFORMAT p1)
          PROXY1(GetPixelFormat);
  STDMETHOD(GetSurfaceDesc)(THIS_ LPDDSURFACEDESC2 p1) PROXY1(GetSurfaceDesc);
  STDMETHOD(Initialize)
  (THIS_ LPDIRECTDRAW p1, LPDDSURFACEDESC2 p2) PROXY2(Initialize);
  STDMETHOD(IsLost)(THIS) PROXY0(IsLost);
  STDMETHOD(Lock)
  (THIS_ LPRECT p1, LPDDSURFACEDESC2 p2, DWORD p3, HANDLE p4) PROXY4(Lock);
  ...
  STDMETHOD(SetOverlayPosition)
  (THIS_ LONG p1, LONG p2) PROXY2(SetOverlayPosition);
  STDMETHOD(SetPalette)(THIS_ LPDIRECTDRAWPALETTE p1) PROXY1(SetPalette);
  STDMETHOD(Unlock)(THIS_ LPRECT p1) PROXY1(Unlock);
  STDMETHOD(UpdateOverlay)
  (THIS_ LPRECT p1, LPDIRECTDRAWSURFACE7 p2, LPRECT p3, DWORD p4,
   LPDDOVERLAYFX p5) PROXY5(UpdateOverlay);
  STDMETHOD(UpdateOverlayDisplay)(THIS_ DWORD p1) PROXY1(UpdateOverlayDisplay);
  STDMETHOD(UpdateOverlayZOrder)
  (THIS_ DWORD p1, LPDIRECTDRAWSURFACE7 p2) PROXY2(UpdateOverlayZOrder);
  ...
  STDMETHOD(SetSurfaceDesc)
  (THIS_ LPDDSURFACEDESC2 p1, DWORD p2) PROXY2(SetSurfaceDesc);

  /*** Added in the v4 interface ***/
  STDMETHOD(SetPrivateData)
  (THIS_ REFGUID p1, LPVOID p2, DWORD p3, DWORD p4) PROXY4(SetPrivateData);
  STDMETHOD(GetPrivateData)
  (THIS_ REFGUID p1, LPVOID p2, LPDWORD p3) PROXY3(GetPrivateData);
...
class CProxyIDirect3DDevice7 final : public IDirect3DDevice7 {
 ...
 public:
  ...
  STDMETHOD(GetCaps)
  (THIS_ LPD3DDEVICEDESC7 p1) PROXY1(GetCaps);
  STDMETHOD(EnumTextureFormats)
  (THIS_ LPD3DENUMPIXELFORMATSCALLBACK p1, LPVOID p2)
      PROXY2(EnumTextureFormats);
  ...
  (THIS_ LPDIRECT3D7 *p1) PROXY1(GetDirect3D);
  STDMETHOD(SetRenderTarget)
  (THIS_ LPDIRECTDRAWSURFACE7 p1, DWORD p2) PROXY2(SetRenderTarget);
  STDMETHOD(GetRenderTarget)
  (THIS_ LPDIRECTDRAWSURFACE7 *p1) PROXY1(GetRenderTarget);
  STDMETHOD(Clear)
  (THIS_ DWORD p1, LPD3DRECT p2, DWORD p3, D3DCOLOR p4, D3DVALUE p5, DWORD p6)
      PROXY6(Clear);
  STDMETHOD(SetTransform)
  (THIS_ D3DTRANSFORMSTATETYPE p1, LPD3DMATRIX p2) PROXY2(SetTransform);
  STDMETHOD(GetTransform)
  (THIS_ D3DTRANSFORMSTATETYPE p1, LPD3DMATRIX p2) PROXY2(GetTransform);
  STDMETHOD(SetViewport)(THIS_ LPD3DVIEWPORT7 p1) PROXY1(SetViewport);

  STDMETHOD(MultiplyTransform)
  (THIS_ D3DTRANSFORMSTATETYPE p1, LPD3DMATRIX p2) PROXY2(MultiplyTransform);
  STDMETHOD(GetViewport)
  (THIS_ LPD3DVIEWPORT7 p1) PROXY1(GetViewport);
  STDMETHOD(SetMaterial)
  (THIS_ LPD3DMATERIAL7 p1) PROXY1(SetMaterial);
  STDMETHOD(GetMaterial)
  (THIS_ LPD3DMATERIAL7 p1) PROXY1(GetMaterial);
  STDMETHOD(SetLight)
  (THIS_ DWORD p1, LPD3DLIGHT7 p2) PROXY2(SetLight);
  ...
  // PROXY2(SetRenderState)
  STDMETHOD(SetRenderState)(THIS_ D3DRENDERSTATETYPE p1, DWORD p2) {
    return Proxy_SetRenderState(p1, p2);
  }

  STDMETHOD(GetRenderState)
  (THIS_ D3DRENDERSTATETYPE p1, LPDWORD p2) PROXY2(GetRenderState);
  STDMETHOD(BeginStateBlock)
  (THIS) PROXY0(BeginStateBlock) STDMETHOD(EndStateBlock)(THIS_ LPDWORD p1)
      PROXY1(EndStateBlock) STDMETHOD(PreLoad)(THIS_ LPDIRECTDRAWSURFACE7 p1)
          PROXY1(PreLoad);
  STDMETHOD(DrawPrimitive)
  (THIS_ D3DPRIMITIVETYPE p1, DWORD p2, LPVOID p3, DWORD p4, DWORD p5)
      PROXY5(DrawPrimitive);

  STDMETHOD(DrawIndexedPrimitive)
  (THIS_ D3DPRIMITIVETYPE p1, DWORD p2, LPVOID p3, DWORD p4, LPWORD p5,
   DWORD p6, DWORD p7) PROXY7(DrawIndexedPrimitive);
  STDMETHOD(SetClipStatus)
  (THIS_ LPD3DCLIPSTATUS p1) PROXY1(SetClipStatus);
  STDMETHOD(GetClipStatus)
  (THIS_ LPD3DCLIPSTATUS p1) PROXY1(GetClipStatus);
  STDMETHOD(DrawPrimitiveStrided)
  (THIS_ D3DPRIMITIVETYPE p1, DWORD p2, LPD3DDRAWPRIMITIVESTRIDEDDATA p3,
   DWORD p4, DWORD p5) PROXY5(DrawPrimitiveStrided);
  STDMETHOD(DrawIndexedPrimitiveStrided)
  (THIS_ D3DPRIMITIVETYPE p1, DWORD p2, LPD3DDRAWPRIMITIVESTRIDEDDATA p3,
   DWORD p4, LPWORD p5, DWORD p6, DWORD p7) PROXY7(DrawIndexedPrimitiveStrided);
  STDMETHOD(DrawPrimitiveVB)
  (THIS_ D3DPRIMITIVETYPE p1, LPDIRECT3DVERTEXBUFFER7 p2, DWORD p3, DWORD p4,
   DWORD p5) PROXY5(DrawPrimitiveVB);
  STDMETHOD(DrawIndexedPrimitiveVB)
  (THIS_ D3DPRIMITIVETYPE p1, LPDIRECT3DVERTEXBUFFER7 p2, DWORD p3, DWORD p4,
   LPWORD p5, DWORD p6, DWORD p7) PROXY7(DrawIndexedPrimitiveVB);
  STDMETHOD(ComputeSphereVisibility)
  (THIS_ LPD3DVECTOR p1, LPD3DVALUE p2, DWORD p3, DWORD p4, LPDWORD p5)
      PROXY5(ComputeSphereVisibility);
  STDMETHOD(GetTexture)
  (THIS_ DWORD p1, LPDIRECTDRAWSURFACE7 *p2) PROXY2(GetTexture);
  STDMETHOD(SetTexture)
  (THIS_ DWORD p1, LPDIRECTDRAWSURFACE7 p2) PROXY2(SetTexture);
  STDMETHOD(GetTextureStageState)
  (THIS_ DWORD p1, D3DTEXTURESTAGESTATETYPE p2, LPDWORD p3)
      PROXY3(GetTextureStageState);
  STDMETHOD(SetTextureStageState)
  (THIS_ DWORD p1, D3DTEXTURESTAGESTATETYPE p2, DWORD p3)
      PROXY3(SetTextureStageState);
  STDMETHOD(ValidateDevice)(THIS_ LPDWORD p1) PROXY1(ValidateDevice);
  STDMETHOD(ApplyStateBlock)
  (THIS_ DWORD p1) PROXY1(ApplyStateBlock);
  STDMETHOD(CaptureStateBlock)
  (THIS_ DWORD p1) PROXY1(CaptureStateBlock);
  STDMETHOD(DeleteStateBlock)
  (THIS_ DWORD p1) PROXY1(DeleteStateBlock);
  STDMETHOD(CreateStateBlock)
  (THIS_ D3DSTATEBLOCKTYPE p1, LPDWORD p2) PROXY2(CreateStateBlock);
  STDMETHOD(Load)
  (THIS_ LPDIRECTDRAWSURFACE7 p1, LPPOINT p2, LPDIRECTDRAWSURFACE7 p3,
   LPRECT p4, DWORD p5) PROXY5(Load);
  STDMETHOD(LightEnable)(THIS_ DWORD p1, BOOL p2) PROXY2(LightEnable);
  STDMETHOD(GetLightEnable)
  (THIS_ DWORD p1, BOOL *p2) PROXY2(GetLightEnable);
  ...
  // Proxy Functions
  //
  HRESULT Proxy_SetRenderState(THIS_ D3DRENDERSTATETYPE dwRenderStateType,
                               DWORD dwRenderState);
...
class CProxyIDirect3D7 final : public IDirect3D7 {
 ...
 public:
  ...
  (THIS_ LPD3DENUMDEVICESCALLBACK7 p1, LPVOID p2) PROXY2(EnumDevices);
  // STDMETHOD(CreateDevice)(THIS_ REFCLSID p1, LPDIRECTDRAWSURFACE7 p2,
  // LPDIRECT3DDEVICE7 *p3) PROXY3(CreateDevice)
  STDMETHOD(CreateDevice)
  (THIS_ REFCLSID p1, LPDIRECTDRAWSURFACE7 p2, LPDIRECT3DDEVICE7 *p3) {
    return Proxy_CreateDevice(p1, p2, p3);
  };
  STDMETHOD(CreateVertexBuffer)
  (THIS_ LPD3DVERTEXBUFFERDESC p1, LPDIRECT3DVERTEXBUFFER7 *p2, DWORD p3)
      PROXY3(CreateVertexBuffer);
  STDMETHOD(EnumZBufferFormats)
  (THIS_ REFCLSID p1, LPD3DENUMPIXELFORMATSCALLBACK p2, LPVOID p3)
      PROXY3(EnumZBufferFormats);
  STDMETHOD(EvictManagedTextures)(THIS) PROXY0(EvictManagedTextures);

  HRESULT
  Proxy_CreateDevice(REFCLSID rclsid, LPDIRECTDRAWSURFACE7 lpDDS,
