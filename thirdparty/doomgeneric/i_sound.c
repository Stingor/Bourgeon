...
// BOURGEON PATCH: SDL_mixer is not used anywhere in this file (leftover from
// the SDL port) and we build FEATURE_SOUND with our own DirectSound backend
// (i_dsound.c) — keep the include out.
